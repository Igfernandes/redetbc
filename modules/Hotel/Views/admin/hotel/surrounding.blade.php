@if(!empty($location_category) and $location_category->count() > 0)
    <div class="panel">
        <div class="panel-title"><strong>{{__("Arredores")}}</strong></div>
                    ...
                    <div class="form-group-item">
                        ...
                        <div class="g-items-header">
                            <div class="row">
                                ...
                                <div class="col-md-3">{{__('Descrição')}}</div>
                                <div class="col-md-3">{{__('Distância')}}</div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text"
                                                       ...
                                                       class="form-control"
                                                       value="{{@$item['name']}}"
                                                       placeholder="{{__('Praia Ens Solarada')}}">
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-2">
                                                <select name="surrounding[{{$category->id}}][{{$key}}][type]"
                                                        class="form-control">
                                                    <option @if($item['type']=='m') selected @endif value="m">{{__('m')}}</option>
                                                    <option @if($item['type']=='km') selected @endif value="km">{{__('Km')}}</option>
                                                </select>
                                            </div>
                                            <div class="col-md-1">
