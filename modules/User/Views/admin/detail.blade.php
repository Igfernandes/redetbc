                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="religion" class="form-control">
                                        ...
                                        <option @if((old('sex',$row->sex)) == "MASCULINE") selected @endif value="MASCULINE">MASCULINE</option>
                                        <option @if((old('sex',  $row->sex)) == "FEMININE") selected @endif value="FEMININE">FEMININE</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="religion" class="form-control">
                                    <option value="">{{__('-- Select --')}}</option>
                                    <option @if((old('religion', $row->religion )) == "CATHOLIC") selected @endif value="CATHOLIC">CATHOLIC</option>
                                    <option @if((old('religion', $row->religion)) == "EVANGELICAL") selected @endif value="EVANGELICAL">EVANGELICAL</option>
                                    <option @if((old('religion', $row->religion)) == "BOTH") selected @endif value="BOTH">BOTH</option>
                                </select>
                            </div>
