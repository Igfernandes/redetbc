...
class RegisterController extends \App\Http\Controllers\Auth\RegisterController
{
    ...
    public function register(Request $request)
    {
        ...
        $messages = [
            ...
            'religion.required'   => __('Religion is required field'),
            'sex.required'         => __('Sex is required field'),
        ...
        if ($validator->fails()) {
            ...
            $user = \App\User::create([
                ...
                'owner_id' => $session->get('vendor_key')
            ]);
            ...
            $user->assignRole($request->input('host') === "Yes" ? 2 : setting_item('user_role'));
            return response()->json([
                'error'    => false,
                'messages' => false,
