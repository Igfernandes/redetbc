...
        @if(is_default_lang())
            <hr class="d-none">
            <h3 class="panel-body-title d-none">{{__('Desconto por número de pessoas')}}</h3>
...
                                    </div>
                                    <div class="col-md-2">
                                        <input type="number" min="0" name="discount_by_people[{{$key}}][to]" class="form-control" value="{{$item['from']}}" placeholder="{{__('Até')}}">
                                    </div>
                                    <div class="col-md-3">
...
                                            <option @if($item['type'] ==  'percent') selected @endif value="percent">{{__("Porcentagem (%)")}}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1">
                                        <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
...
                        <div class="row">
                            <div class="col-md-2">
                                <input type="number" min="0" __name__="discount_by_people[__number__][from]" class="form-control" value="" placeholder="{{__('De')}}">
                            </div>
                            <div class="col-md-2">
                                <input type="number" min="0" __name__="discount_by_people[__number__][to]" class="form-control" value="" placeholder="{{__('Até')}}">
                            </div>
                            <div class="col-md-3">
...
                                            <option @if(($item['unit'] ?? "") ==  'percent') selected @endif value="percent">{{ __("Porcentagem") }}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
