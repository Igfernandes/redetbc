...
@section ('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Calendário de Disponibilidade dos Espaços")}}</h1>
        </div>
        ...
        @else
            <div class="alert alert-warning">{{__("Nenhum espaço encontrado")}}</div>
        @endif
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">{{__('Informações da data')}}</h5>
                    ...
                    <form class="row form_modal_calendar form-horizontal" novalidate onsubmit="return false">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{__('Intervalo de datas')}}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label>
                                    <input true-value=1 false-value=0 type="checkbox" v-model="form.active">
                                    {{__('Disponível para reserva?')}}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-none" v-show="form.active">
                            <div class="form-group">
                                <label>{{__('Reserva Instantânea?')}}</label><br>
                                <label>
                                    <input true-value=1 false-value=0 type="checkbox" v-model="form.is_instant">
                                    {{__("Habilitar reserva instantânea")}}
                                </label>
                            </div>
                        </div>
...
@push('js')
    ...
    <script>
        ...
        formModal = new Vue({
            ...
            data:{
                lastResponse:{ status:null, message:'' },
                form:{
                    id:'', price:'', start_date:'', end_date:'',
                    is_instant:'', enable_person:0, min_guests:0,
                    max_guests:0, active:0
                },
                formDefault:{
                    id:'', price:'', start_date:'', end_date:'',
                    is_instant:'', enable_person:0, min_guests:0,
                ...
                person_types:[],
                person_type_item:{ name:'', desc:'', min:'', max:'', price:'' },
                onSubmit:false
            },
