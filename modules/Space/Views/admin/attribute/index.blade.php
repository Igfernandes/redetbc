...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Atributos de espaço")}}</h1>
        </div>
                                ...
                                @if(count($rows) > 0)
                                    @foreach($rows as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('space.admin.attribute.edit',['id'=>$row->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> {{__('Editar')}}
                                                </a>
                                                <a href="{{route('space.admin.attribute.term.index',['id'=>$row->id])}}" class="btn btn-sm btn-success"><i class="fa fa"></i> {{__("Gerenciador de Termos")}}
                                                </a>
