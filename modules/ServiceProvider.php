...
{
    protected static $coreModuleNames = ['Api','Social','Sms','Page','News', 'Assistance','Admin','Booking','Order','Contact','Core','Dashboard','Email','Language','Layout','Media','Report','Review','Template','Theme','Tracking','Type','User','Vendor'];
