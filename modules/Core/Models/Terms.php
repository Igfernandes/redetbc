...
class Terms extends BaseModel
{
    ...
    {
        return $this->belongsToMany(Assistance::class, AssistanceTerm::getTableName(), 'term_id', 'assistance_id');
    }
    ...
    {
        return $this->belongsToMany(Assistance::class, AssistanceTerm::getTableName(), 'term_id', 'target_id');
    }
}
