<div class="panel">
    <div class="panel-title"><strong>{{__("Locais")}}</strong></div>
        ...
        @if(is_default_lang())
            <div class="form-group">
                ...
                <div class="control-map-group">
                    ...
                    <input type="text" placeholder="{{__("Pesquisar por nome...")}}" class="bravo_searchbox form-control" autocomplete="off" onkeydown="return event.key !== 'Enter';">
                    <div class="g-control">
                        <div class="form-group">
