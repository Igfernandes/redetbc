    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                @if(is_default_lang())
                <div class="form-group">
                    <label>{{__("Postes por página")}}</label>
                    <div class="form-controls">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Opções da Barra Lateral")}}</h3>
        <p class="form-group-desc">{{__('Configurar barra lateral para notícias')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control" __name__="news_sidebar[__number__][type]">
                                                ...
                                                <option value="content_text">{{__("Texto do Conteúdo")}}</option>
                                            </select>
                                        </div>
                                        <div class="col-md-1">
                                            <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
