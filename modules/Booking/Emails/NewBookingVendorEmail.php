...
class NewBookingVendorEmail extends Mailable
{
    ...
    public function build()
    {
        ...
        $subject = __('[:site_name] Você recebeu uma nova solicitação sobre o seu imóvel', [
            'site_name' => $site_name
        ]);
        ...
        return $this->subject($subject)
            ->view('Booking::emails.booking-vendor')
            ->with([
                'booking' => $this->booking,
                'client' => $this->client,
