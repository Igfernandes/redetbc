...
                        },
                        settings_modal: {
                            title: '{{ setting_item('cookie_consent_setting_modal_title',__('Preferências de cookies')) }}',
                            save_settings_btn: '{{ setting_item('cookie_consent_setting_modal_save',__('Salvar configurações')) }}',
                            accept_all_btn: '{{ setting_item('cookie_consent_setting_modal_accept',__('Aceitar todos')) }}',
                            reject_all_btn: '{{ setting_item('cookie_consent_setting_modal_reject',__('Rejeitar todos')) }}',
