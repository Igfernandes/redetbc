                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-controls">
                                    <select name="assistance_location_search_style" class="form-control">
                                        ...
                                        <option {{ ($settings['assistance_location_search_style'] ?? '') == 'autocomplete' ? 'selected' : '' }} value="autocomplete">{{__('Autocomplete from locations')}}</option>
                                        <option {{ ($settings['assistance_location_search_style'] ?? '') == 'autocompletePlace' ? 'selected' : '' }} value="autocompletePlace">{{__('Autocomplete from Gmap Place')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-controls">
                                    <input type="number" min="1" name="assistance_page_limit_item" placeholder="{{ __("Default: 9") }}" value="{{setting_item_with_lang('assistance_page_limit_item',request()->query('lang'), 9)}}" class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <select name="assistance_location_radius_type" id="">
                                        <option  {{ (setting_item('assistance_location_radius_type') ?? '') == 3959 ? 'selected' : ''  }} value="3959">{{__('Miles')}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="assistance_layout_map_option" class="form-control">
                                <option {{ (setting_item_with_lang('assistance_layout_map_option',request()->query('lang')) ?? '') == 'map_left' ? 'selected' : '' }} value="map_left">{{__('Map Left')}}</option>
                                <option {{ (setting_item_with_lang('assistance_layout_map_option',request()->query('lang')) ?? '') == 'map_right' ? 'selected' : ''  }} value="map_right">{{__("Map Right")}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="tab-content" >
                        <div class="tab-pane active" id="seo_1">
                            <div class="form-group" >
                                ...
                                <input type="text" name="assistance_page_list_seo_title" class="form-control" placeholder="{{__("Enter title...")}}" value="{{ setting_item_with_lang('assistance_page_list_seo_title',request()->query('lang'))}}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Seo Description")}}</label>
                                <input type="text" name="assistance_page_list_seo_desc" class="form-control" placeholder="{{__("Enter description...")}}" value="{{setting_item_with_lang('assistance_page_list_seo_desc',request()->query('lang'))}}">
                            </div>
                            @if(is_default_lang())
                        ...
                        <div class="tab-pane" id="seo_2">
                            <div class="form-group">
                                ...
                                <input type="text" name="assistance_page_list_seo_share[facebook][title]" class="form-control" placeholder="{{__("Enter title...")}}" value="{{$seo_share['facebook']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Facebook Description")}}</label>
                                <input type="text" name="assistance_page_list_seo_share[facebook][desc]" class="form-control" placeholder="{{__("Enter description...")}}" value="{{$seo_share['facebook']['desc'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                        ...
                        <div class="tab-pane" id="seo_3">
                            <div class="form-group">
                                ...
                                <input type="text" name="assistance_page_list_seo_share[twitter][title]" class="form-control" placeholder="{{__("Enter title...")}}" value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Twitter Description")}}</label>
                                <input type="text" name="assistance_page_list_seo_share[twitter][desc]" class="form-control" placeholder="{{__("Enter description...")}}" value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config review for assistance')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Enable review system for Assistance?")}}</label>
                        <div class="form-controls">
                            <label><input type="checkbox" name="assistance_enable_review" value="1" @if(!empty($settings['assistance_enable_review'])) checked @endif /> {{__("Yes, please enable it")}} </label>
                            <br>
                    ...
                    <div class="form-group" data-condition="assistance_enable_review:is(1)">
                        <label class="" >{{__("Customer must book a assistance before writing a review?")}}</label>
                        <div class="form-controls">
                            <label><input type="checkbox" name="assistance_enable_review_after_booking" value="1"  @if(!empty($settings['assistance_enable_review_after_booking'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                    ...
                    <div class="form-group" data-condition="assistance_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="assistance_review_approved" value="1"  @if(!empty($settings['assistance_review_approved'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                            ...
                            <div class="form-group-item">
                                ...
                                <div class="g-items">
                                    ...
                                    @foreach($social_share as $key=>$item)
                                        <div class="item" data-number="{{$key}}">
                                            <div class="row">
                                                <div class="col-md-11">
                                                    <input type="text" name="assistance_review_stats[{{$key}}][title]" class="form-control" value="{{$item->title}}" placeholder="{{__('Eg: Service')}}">
                                                </div>
                                                <div class="col-md-1">
                                ...
                                <div class="g-more hide">
                                    <div class="item" data-number="__number__">
                                        <div class="row">
                                            <div class="col-md-11">
                                                <input type="text" __name__="assistance_review_stats[__number__][title]" class="form-control" value="" placeholder="{{__('Eg: Service')}}">
                                            </div>
                                            <div class="col-md-1">
                                                <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                                            </div>
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config buyer fees for assistance')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                                                ...
                                                @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                    @foreach($languages as $language)
                                                        ...
                                                        <div class="g-lang">
                                                            ...
                                                            <input type="text" name="assistance_booking_buyer_fees[{{$key}}][name{{$key_lang}}]" class="form-control" value="{{$buyer_fee['name'.$key_lang] ?? ''}}" placeholder="{{__('Fee name')}}">
                                                            <input type="text" name="assistance_booking_buyer_fees[{{$key}}][desc{{$key_lang}}]" class="form-control" value="{{$buyer_fee['desc'.$key_lang] ?? ''}}" placeholder="{{__('Fee desc')}}">
                                                        </div>

                                                    @endforeach
                                                @else
                                                    <input type="text" name="assistance_booking_buyer_fees[{{$key}}][name]" class="form-control" value="{{$buyer_fee['name'] ?? ''}}" placeholder="{{__('Fee name')}}">
                                                    <input type="text" name="assistance_booking_buyer_fees[{{$key}}][desc]" class="form-control" value="{{$buyer_fee['desc'] ?? ''}}" placeholder="{{__('Fee desc')}}">
                                                @endif
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    <div class="col-md-7">
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text" __name__="assistance_booking_buyer_fees[__number__][name{{$key}}]" class="form-control" value="" placeholder="{{__('Fee name')}}">
                                                    <input type="text" __name__="assistance_booking_buyer_fees[__number__][desc{{$key}}]" class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                                </div>

                                            @endforeach
                                        @else
                                            <input type="text" __name__="assistance_booking_buyer_fees[__number__][name]" class="form-control" value="" placeholder="{{__('Fee name')}}">
                                            <input type="text" __name__="assistance_booking_buyer_fees[__number__][desc]" class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                        @endif
                                    </div>
                                    <div class="col-md-4">
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Vendor config for assistance')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Service created by vendor must be approved by admin")}}</label>
                        <div class="form-controls">
                            <label><input type="checkbox" name="assistance_vendor_create_service_must_approved_by_admin" value="1" @if(!empty($settings['assistance_vendor_create_service_must_approved_by_admin'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="assistance_allow_vendor_can_change_their_booking_status" value="1" @if(!empty($settings['assistance_allow_vendor_can_change_their_booking_status'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="assistance_allow_vendor_can_change_paid_amount" value="1" @if(!empty($settings['assistance_allow_vendor_can_change_paid_amount'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="assistance_allow_vendor_can_add_service_fee" value="1" @if(!empty($settings['assistance_allow_vendor_can_add_service_fee'])) checked @endif /> {{__("Yes please")}} </label>
                            <br>
    ...
    <div class="col-sm-8">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
                    <label><input type="checkbox" name="assistance_deposit_enable" value="1" @if(setting_item('assistance_deposit_enable')) checked @endif > {{__('Yes, please enable it')}}</label>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <select name="assistance_deposit_type"  class="form-control">
                                        <option value="fixed">{{__("Fixed")}}</option>
                                        <option @if(old('assistance_deposit_type',setting_item('assistance_deposit_type')) == 'percent') selected @endif value="percent">{{__("Percent")}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <select name="assistance_deposit_fomular" class="form-control" >
                                    <option value="default" {{($settings['assistance_deposit_fomular'] ?? '') == 'default' ? 'selected' : ''  }}>{{__('Default')}}</option>
                                    <option value="deposit_and_fee" {{ ($settings['assistance_deposit_fomular'] ?? '') == 'deposit_and_fee' ? 'selected' : ''  }}>{{__("Deposit amount + Buyer free")}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Disable assistance module?")}}</h3>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-title"><strong>{{__("Disable assistance module")}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
                    <label><input type="checkbox" name="assistance_disable" value="1" @if(setting_item('assistance_disable')) checked @endif > {{__('Yes, please disable it')}}</label>
                    </div>
                </div>
            </div>
        </div>
