                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="assistance_layout_search" class="form-control" >
                            @foreach(config('assistance.layouts',['normal'=>__("Layout Normal"),'map'=>__("Layout com Mapa")]) as $id=>$name)
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <select name="assistance_location_search_style" class="form-control">
                                    ...
                                    <option {{ ($settings['assistance_location_search_style'] ?? '') == 'autocomplete' ? 'selected' : '' }} value="autocomplete">{{__('Autocomplete de Localizações')}}</option>
                                    <option {{ ($settings['assistance_location_search_style'] ?? '') == 'autocompletePlace' ? 'selected' : '' }} value="autocompletePlace">{{__('Autocomplete do Google Places')}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="seo_1">
                            <div class="form-group">
                                ...
                                <input type="text" name="assistance_page_list_seo_title" class="form-control" placeholder="{{__("Digite o título...")}}" value="{{ setting_item_with_lang('assistance_page_list_seo_title',request()->query('lang'))}}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Descrição SEO")}}</label>
                                <input type="text" name="assistance_page_list_seo_desc" class="form-control" placeholder="{{__("Digite a descrição...")}}" value="{{setting_item_with_lang('assistance_page_list_seo_desc',request()->query('lang'))}}">
                            </div>
                            @if(is_default_lang())
                        ...
                        <div class="tab-pane" id="seo_2">
                            <div class="form-group">
                                ...
                                <input type="text" name="assistance_page_list_seo_share[facebook][title]" class="form-control" placeholder="{{__("Digite o título...")}}" value="{{$seo_share['facebook']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Descrição para Facebook")}}</label>
                                <input type="text" name="assistance_page_list_seo_share[facebook][desc]" class="form-control" placeholder="{{__("Digite a descrição...")}}" value="{{$seo_share['facebook']['desc'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                        ...
                        <div class="tab-pane" id="seo_3">
                            <div class="form-group">
                                ...
                                <input type="text" name="assistance_page_list_seo_share[twitter][title]" class="form-control" placeholder="{{__("Digite o título...")}}" value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Descrição para Twitter")}}</label>
                                <input type="text" name="assistance_page_list_seo_share[twitter][desc]" class="form-control" placeholder="{{__("Digite a descrição...")}}" value="{{$seo_share['twitter']['desc'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
...
<div class="row">
    <div class="col-sm-4">
        ...
        <p class="form-group-desc">{{__('Configurar avaliações para o serviço')}}</p>
    </div>
    <div class="col-sm-8">
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="" >{{__("Ativar sistema de avaliações para serviços?")}}</label>
                    <div class="form-controls">
                        <label><input type="checkbox" name="assistance_enable_review" value="1" @if(!empty($settings['assistance_enable_review'])) checked @endif /> {{__("Sim, ativar")}} </label>
                        <br>
                        <small class="form-text text-muted">{{__("Ative o modo de avaliações para os serviços")}}</small>
                    </div>
                </div>
                ...
                <div class="form-group" data-condition="assistance_enable_review:is(1)">
                    ...
                    <div class="form-controls">
                        <label><input type="checkbox" name="assistance_enable_review_after_booking" value="1" @if(!empty($settings['assistance_enable_review_after_booking'])) checked @endif /> {{__("Sim")}} </label>
                        <br>
                ...
                <div class="form-group" data-condition="assistance_enable_review:is(1)">
                    ...
                    <div class="form-controls">
                        <label><input type="checkbox" name="assistance_review_approved" value="1" @if(!empty($settings['assistance_review_approved'])) checked @endif /> {{__("Sim")}} </label>
                        <br>
                ...
                <div class="form-group" data-condition="assistance_enable_review:is(1)">
                    ...
                    <div class="form-controls">
                        ...
                        <div class="form-group-item">
                            ...
                            <div class="g-items">
                                <?php if(!empty($settings['assistance_review_stats'])){
                            ...
                            <div class="g-more hide">
                                <div class="item" data-number="__number__">
                                    <div class="row">
                                        <div class="col-md-11">
                                            <input type="text" __name__="assistance_review_stats[__number__][title]" class="form-control" placeholder="{{__('Ex: Serviço')}}">
                                        </div>
                                        <div class="col-md-1">
                                            <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                                        </div>
                            ...
                            @foreach($assistance_booking_buyer_fees as $key=>$buyer_fee)
                                ...
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select name="assistance_booking_buyer_fees[{{$key}}][type]" class="form-control d-none">
                                                <option @if($buyer_fee['type'] ?? "" == 'one_time') selected @endif value="one_time">{{__("Única")}}</option>
                                            </select>

                                            <label>
                                                <input type="checkbox" name="assistance_booking_buyer_fees[{{$key}}][per_person]" value="on" @if($buyer_fee['per_person'] ?? '') checked @endif >
                                                {{__("Preço por pessoa")}}
                                            </label>
                                        </div>
                    ...
                    <div class="g-more hide">
                        <div class="item" data-number="__number__">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" __name__="assistance_booking_buyer_fees[__number__][name]" class="form-control" placeholder="{{__('Nome da taxa')}}">
                                    <input type="text" __name__="assistance_booking_buyer_fees[__number__][desc]" class="form-control" placeholder="{{__('Descrição da taxa')}}">
                                </div>

                                <div class="col-md-3">
                                    <input type="number" min="0" step="0.1" __name__="assistance_booking_buyer_fees[__number__][price]" class="form-control">
                                ...
                                <div class="col-md-3">
                                    <label>
                                        <input type="checkbox" __name__="assistance_booking_buyer_fees[__number__][per_person]" value="on">
                                        {{__("Preço por pessoa")}}
                                    </label>
                                </div>
