            ...
            <div class="form-group" >
                ...
                <div class="form-controls">
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            @php
                            $assistance_search_fields = setting_item_array('assistance_search_fields');
                            $types = [
                            ...
                            @foreach($assistance_search_fields as $key=>$item)
                                <div class="item" data-number="{{$key}}">
                                    <div class="row">
                                            ...
                                            @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                @foreach($languages as $language)
                                                    ...
                                                    <div class="g-lang">
                                                        ...
                                                        <input type="text" name="assistance_search_fields[{{$key}}][title{{$key_lang}}]" value="{{$item['title'.$key_lang] ?? ''}}" class="form-control">
                                                    </div>
                                                @endforeach
                                            @else
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="assistance_search_fields[{{$key}}][position]" min="0" value="{{$item['position'] ?? 0}}" class="form-control">
                                        </div>
                                        <div class="col-md-1">
                        ...
                        <div class="g-more hide">
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    <div class="col-md-7">
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text" __name__="assistance_search_fields[__number__][title{{$key_lang}}]" class="form-control">
                                                </div>
                                            @endforeach
                                        @else
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" __name__="assistance_search_fields[__number__][position]" min="0"  class="form-control">
                                    </div>
                                    <div class="col-md-1">
                                        <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                                    </div>
