<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="control-label">{{__("Serviço - Mínimo de Pessoas")}}</label>
                    <input type="text" name="min_people" class="form-control" value="{{old('min_people',$row->min_people)}}" placeholder="{{__("Serviço - Mínimo de Pessoas")}}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="control-label">{{__("Serviço - Máximo de Pessoas")}}</label>
                    <input type="text" name="max_people" class="form-control" value="{{old('max_people',$row->max_people)}}" placeholder="{{__("Serviço - Máximo de Pessoas")}}">
                </div>
            </div>
        </div>

        @endif
        <?php do_action(\Modules\Assistance\Hook::FORM_AFTER_MAX_PEOPLE, $row) ?>
        <div class="form-group-item">
            ...
            <div class="g-items">
                ...
                <div class="item" data-number="{{$key}}">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" name="faqs[{{$key}}][title]" class="form-control" value="{{$faq['title']}}" placeholder="{{__('Ex: Quando e onde o serviço termina?')}}">
                        </div>
                        <div class="col-md-6">
            ...
            <div class="g-more hide">
                <div class="item" data-number="__number__">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" __name__="faqs[__number__][title]" class="form-control" placeholder="{{__('Ex: Quando e onde o serviço termina?')}}">
                        </div>
                        <div class="col-md-6">
        ...
        @include('Assistance::admin/assistance/itinerary')
