<div class="panel">
    ...
    <div class="panel-body">
        ...
        @if(is_default_lang())
            <div class="form-group">
                <label class="control-label">{{__("Coordenada geográfica")}}</label>
                <div class="control-map-group">
                    <div id="map_content"></div>
                    <input type="text" placeholder="{{__("Procurar por nome...")}}" class="bravo_searchbox form-control" autocomplete="off" onkeydown="return event.key !== 'Enter';">
                    <div class="g-control">
                        <div class="form-group">
