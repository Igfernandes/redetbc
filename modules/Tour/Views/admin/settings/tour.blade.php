                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="tour_layout_search" class="form-control" >
                            @foreach(config('tour.layouts',['normal'=>__("Layout Normal"),'map'=>__("Layout com Mapa")]) as $id=>$name)
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <select name="tour_location_search_style" class="form-control">
                                    ...
                                    <option {{ ($settings['tour_location_search_style'] ?? '') == 'autocomplete' ? 'selected' : '' }} value="autocomplete">{{__('Autocomplete de Localizações')}}</option>
                                    <option {{ ($settings['tour_location_search_style'] ?? '') == 'autocompletePlace' ? 'selected' : '' }} value="autocompletePlace">{{__('Autocomplete do Google Places')}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="number" min="1" name="tour_page_limit_item" placeholder="{{ __("Padrão: 9") }}" value="{{setting_item_with_lang('tour_page_limit_item',request()->query('lang'), 9)}}" class="form-control">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="input-group-append">
                                <select name="tour_location_radius_type" id="">
                                    <option {{ (setting_item('tour_location_radius_type') ?? '') == 3959 ? 'selected' : ''  }} value="3959">{{__('Milhas')}}</option>
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="tour_layout_map_option" class="form-control">
                            <option {{ (setting_item_with_lang('tour_layout_map_option',request()->query('lang')) ?? '') == 'map_left' ? 'selected' : '' }} value="map_left">{{__('Mapa à Esquerda')}}</option>
                            <option {{ (setting_item_with_lang('tour_layout_map_option',request()->query('lang')) ?? '') == 'map_right' ? 'selected' : ''  }} value="map_right">{{__("Mapa à Direita")}}</option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12 mt-1">
                        <i>{{ __('Pegue lat - lng aqui') }} <a href="https://www.latlong.net" target="_blank">https://www.latlong.net</a></i>
                    </div>
                </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="seo_1">
                            <div class="form-group">
                                ...
                                <input type="text" name="tour_page_list_seo_title" class="form-control" placeholder="{{__("Digite o título...")}}" value="{{ setting_item_with_lang('tour_page_list_seo_title',request()->query('lang'))}}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Descrição SEO")}}</label>
                                <input type="text" name="tour_page_list_seo_desc" class="form-control" placeholder="{{__("Digite a descrição...")}}" value="{{setting_item_with_lang('tour_page_list_seo_desc',request()->query('lang'))}}">
                            </div>
                            @if(is_default_lang())
                        ...
                        <div class="tab-pane" id="seo_2">
                            <div class="form-group">
                                ...
                                <input type="text" name="tour_page_list_seo_share[facebook][title]" class="form-control" placeholder="{{__("Digite o título...")}}" value="{{$seo_share['facebook']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Descrição para Facebook")}}</label>
                                <input type="text" name="tour_page_list_seo_share[facebook][desc]" class="form-control" placeholder="{{__("Digite a descrição...")}}" value="{{$seo_share['facebook']['desc'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                        ...
                        <div class="tab-pane" id="seo_3">
                            <div class="form-group">
                                ...
                                <input type="text" name="tour_page_list_seo_share[twitter][title]" class="form-control" placeholder="{{__("Digite o título...")}}" value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Descrição para Twitter")}}</label>
                                <input type="text" name="tour_page_list_seo_share[twitter][desc]" class="form-control" placeholder="{{__("Digite a descrição...")}}" value="{{$seo_share['twitter']['desc'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Opções de Avaliação")}}</h3>
        <p class="form-group-desc">{{__('Configurar avaliações para o tour')}}</p>
    </div>
    <div class="col-sm-8">
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="" >{{__("Ativar sistema de avaliações para Tour?")}}</label>
                    <div class="form-controls">
                        <label><input type="checkbox" name="tour_enable_review" value="1" @if(!empty($settings['tour_enable_review'])) checked @endif /> {{__("Sim, ativar")}} </label>
                        <br>
                        <small class="form-text text-muted">{{__("Ative o modo de avaliações para os tours")}}</small>
                    </div>
                </div>

                <div class="form-group" data-condition="tour_enable_review:is(1)">
                    <label class="" >{{__("Cliente precisa reservar antes de avaliar?")}}</label>
                    <div class="form-controls">
                        <label><input type="checkbox" name="tour_enable_review_after_booking" value="1" @if(!empty($settings['tour_enable_review_after_booking'])) checked @endif /> {{__("Sim")}} </label>
                        <br>
                        <small class="form-text text-muted">{{__("Ligado: só permite avaliar após reserva — Desligado: qualquer um pode avaliar")}}</small>
                    </div>
                </div>
                ...
                <div class="form-group" data-condition="tour_enable_review:is(1),tour_enable_review_after_booking:is(1)">
                    ...
                    <div class="form-controls">
                        ...
                        <small class="form-text text-muted">{{__("Escolha os status que permitem avaliação")}}</small>
                ...
                <div class="form-group" data-condition="tour_enable_review:is(1)">
                    <label class="" >{{__("Avaliações precisam ser aprovadas pelo admin?")}}</label>
                    <div class="form-controls">
                        <label><input type="checkbox" name="tour_review_approved" value="1" @if(!empty($settings['tour_review_approved'])) checked @endif /> {{__("Sim")}} </label>
                        <br>
                        <small class="form-text text-muted">{{__("Ligado: Admin precisa aprovar — Desligado: aprovação automática")}}</small>
                    </div>
                </div>
                ...
                <div class="form-group" data-condition="tour_enable_review:is(1)">
                    ...
                    <div class="form-controls">
                        ...
                        <small class="form-text text-muted">{{__("Paginação dos comentários")}}</small>
                    </div>
                </div>
                ...
                <div class="form-group" data-condition="tour_enable_review:is(1)">
                    ...
                    <div class="form-controls">
                        ...
                        <div class="form-group-item">
                            ...
                            <div class="g-items">
                                <?php if(!empty($settings['tour_review_stats'])){
                                ...
                                @foreach($social_share as $key=>$item)
                                    <div class="item" data-number="{{$key}}">
                                        <div class="row">
                                            <div class="col-md-11">
                                                <input type="text" name="tour_review_stats[{{$key}}][title]" class="form-control" value="{{$item->title}}" placeholder="{{__('Ex: Serviço')}}">
                                            </div>
                                            <div class="col-md-1">
                            ...
                            <div class="g-more hide">
                                <div class="item" data-number="__number__">
                                    <div class="row">
                                        <div class="col-md-11">
                                            <input type="text" __name__="tour_review_stats[__number__][title]" class="form-control" placeholder="{{__('Ex: Serviço')}}">
                                        </div>
                                        <div class="col-md-1">
                                            <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                                        </div>
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Opções de Taxas do Comprador")}}</h3>
        <p class="form-group-desc">{{__('Configurar taxas cobradas do comprador')}}</p>
    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                @foreach($languages as $language)
                                                    ...
                                                    <div class="g-lang">
                                                        ...
                                                        <input type="text" name="tour_booking_buyer_fees[{{$key}}][name{{$key_lang}}]" class="form-control" value="{{$buyer_fee['name'.$key_lang] ?? ''}}" placeholder="{{__('Nome da taxa')}}">
                                                        <input type="text" name="tour_booking_buyer_fees[{{$key}}][desc{{$key_lang}}]" class="form-control" value="{{$buyer_fee['desc'.$key_lang] ?? ''}}" placeholder="{{__('Descrição da taxa')}}">
                                                    </div>
                                                @endforeach
                                            @else
                                                <input type="text" name="tour_booking_buyer_fees[{{$key}}][name]" class="form-control" value="{{$buyer_fee['name'] ?? ''}}" placeholder="{{__('Nome da taxa')}}">
                                                <input type="text" name="tour_booking_buyer_fees[{{$key}}][desc]" class="form-control" value="{{$buyer_fee['desc'] ?? ''}}" placeholder="{{__('Descrição da taxa')}}">
                                            @endif
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="tour_booking_buyer_fees[{{$key}}][unit]" class="form-control">
                                                ...
                                                <option @if(($buyer_fee['unit'] ?? "") ==  'percent') selected @endif value="percent">{{ __("Porcentagem") }}</option>
                                            </select>
                                        </div>

                                        <div class="col-md-3">
                                            <select name="tour_booking_buyer_fees[{{$key}}][type]" class="form-control d-none">
                                                <option @if($buyer_fee['type'] ?? "" == 'one_time') selected @endif value="one_time">{{__("Única")}}</option>
                                            </select>

                                            <label>
                                                <input type="checkbox" name="tour_booking_buyer_fees[{{$key}}][per_person]" value="on" @if($buyer_fee['per_person'] ?? '') checked @endif >
                                                {{__("Preço por pessoa")}}
                                            </label>
                                        </div>
                    ...
                    <div class="g-more hide">
                        <div class="item" data-number="__number__">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" __name__="tour_booking_buyer_fees[__number__][name]" class="form-control" placeholder="{{__('Nome da taxa')}}">
                                    <input type="text" __name__="tour_booking_buyer_fees[__number__][desc]" class="form-control" placeholder="{{__('Descrição da taxa')}}">
                                </div>

                                <div class="col-md-3">
                                    <input type="number" min="0" step="0.1" __name__="tour_booking_buyer_fees[__number__][price]" class="form-control">
                                    <select __name__="tour_booking_buyer_fees[__number__][unit]" class="form-control">
                                        <option value="fixed">{{ __("Fixo") }}</option>
                                        <option value="percent">{{ __("Porcentagem") }}</option>
                                    </select>
                                </div>

                                <div class="col-md-3">
                                    <label>
                                        <input type="checkbox" __name__="tour_booking_buyer_fees[__number__][per_person]" value="on">
                                        {{__("Preço por pessoa")}}
                                    </label>
                                </div>
