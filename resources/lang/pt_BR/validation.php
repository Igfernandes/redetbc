...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Essas linhas contêm as mensagens de erro padrão usadas pela classe
    | Validator. Algumas regras têm várias versões, como regras de tamanho.
    | Fique à vontade para ajustar cada uma dessas mensagens aqui.
    |
    */
    ...
    'decimal' => 'O campo :attribute deve ter :decimal Espaços decimais.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Permite substituir os nomes dos atributos nas mensagens.
    |
    */
