    ...
    <table style="background-color: #fff; width: 550px;margin: 0 auto;">
        ...
        <tbody>
                ...
                <td style="text-align: center;border-bottom: 10px solid #ececec;padding: 35px 0;">
                    <div>
                        ...
                        <a href="{{ url('/user/chat?bk=' . $booking['id']) }}" target="_blank" rel="noopener noreferrer">
                            {{ __('Enviar Mensagem para o solicitante') }}
                        </a>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td style="text-align: center;border-bottom: 10px solid #ececec;padding: 35px 0;">
                    <div>
                        <h2>{{ __('Se preferir, ligue diretamente para o solicitante.') }}</h2>
                        <a href="tel:{{ $client['phone'] }}" target="_blank" rel="noopener noreferrer">
                            {{ __('Ligar para o solicitante') }}
                        </a>
                    </div>
                    <div>
                        <div>
                        ...
                        <div>
                            <p style="margin: 10px 0;">{{ $client['name'] }}</p>
                            <span style="color: gray;font-size: 1.2rem;">{{ $client['phone'] }}</span>
                        </div>
                    </div>
                </td>
            </tr>
