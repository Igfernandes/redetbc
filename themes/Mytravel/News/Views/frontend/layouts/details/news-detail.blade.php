...
<div class="mb-4">
    ...
    <div class="space-between">
        ...
        <div class="share"> {{__("Compartilhar")}}
            ...
            <!-- WhatsApp -->
            <a class="whatsapp share-item"
                href="https://api.whatsapp.com/send?text={{$translation->title}} {{$row->getDetailUrl()}}"
                target="_blank"
                title="{{__('WhatsApp')}}">
                <i class="fa fa-whatsapp fa-lg"></i>
            </a>

            <a class="instagram share-item" href="#"
                onclick="navigator.clipboard.writeText('{{$row->getDetailUrl()}}'); alert('Link copiado para compartilhar no Instagram');">
