                        ...
                        <div class="mb-5 pb-1">
                            ...
                            @else
                                <div class="alert alert-danger">
                                    {{__("Desculpe, mas nenhum resultado correspondeu aos seus termos de pesquisa. Por favor, tente novamente com outras palavras-chave.")}}
                                </div>
                            @endif
                        </div>
                        @if($rows->total() > 0)
                            <div class="text-center text-md-left font-size-14 mb-3 text-lh-1">{{ __("Mostrando :from - :to of :total",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()]) }}</div>
                        @endif
