    ...
    <div class="mb-0">
        <div class="input-group border-bottom border-width-2 border-color-1">
            ...
            <div class="smart-search border-0 p-0 form-control  height-40">
                <input type="text" class="smart-select font-weight-bold parent_text form-control" readonly placeholder="{
{__(" Todos :name",['name'=>$attr_translate->name])}}" value="{{ $selected ? $selected->name ?? '' :'' }}" data-default="{{ json_encode($list_cat_json) }}">
