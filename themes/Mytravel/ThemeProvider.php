...
use Themes\Mytravel\Assistance\Blocks\ListAssistances;
...
class ThemeProvider extends \Themes\Base\ThemeProvider
{
    ...
    public static function getTemplateBlocks()
    {
        return [
            ...
            'list_assistances' => ListAssistances::class,
    ...
    public function register()
    {
        ...
        $this->app->register(\Themes\Mytravel\Assistance\ModuleProvider::class);
