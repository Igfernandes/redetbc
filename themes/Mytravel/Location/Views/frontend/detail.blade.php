            ...
            <div class="border-bottom border-color-8">
                <div class="container space-bottom-1 space-top-lg-3">
                    <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-4 mb-xl-7 pb-xl-1">
                        <h2 class="section-title text-black font-size-30 font-weight-bold mb-0">{{ __('Bem-vindo a :name',['name' => $translation->name]) }}</h2>
                    </div>
            ...
            <div class="container space-lg-1">
                ...
                <div class="mb-4 mb-lg-6">
                    ...
                    <div class="text-center">
                        <a class="text-center btn btn-md-wide border-width-2 btn-outline-navy font-weight-semi-bold px-5 transition-3d-hover" href="{{ url('/news')  }}">{{ __('Ler Mais Artigos') }}</a>
                    </div>
                </div>
            </div>
        </div>
