...
@section('content')
    <div class="bravo_detail_assistance">
        @include('Assistance::frontend.layouts.details.banner')
        <div class="bravo_content">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-9">
                        @php $review_score = $row->review_data @endphp
                        @include('Assistance::frontend.layouts.details.detail')
                        @include('Assistance::frontend.layouts.details.review')
                    </div>
                    <div class="col-md-12 col-lg-3">
                        @include('Assistance::frontend.layouts.details.form-book')
                        @include('Tour::frontend.layouts.details.vendor')
                    </div>
                </div>
                <div class="row end_tour_sticky">
                    <div class="col-md-12">
                        @include('Assistance::frontend.layouts.details.related')
                    </div>
                </div>
            </div>
        </div>
        @include('Assistance::frontend.layouts.details.form-book-mobile')
    </div>
@endsection
