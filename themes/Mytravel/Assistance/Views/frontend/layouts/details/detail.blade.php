<?php
/**
 * @var $translation \Modules\Assistance\Models\AssistanceTranslation
 * @var $row \Modules\Assistance\Models\Assistance
 */
?>
<div class="g-header">
    <div class="left">
...
<div class="g-assistance-feature">
    <div class="row">
        @if($row->max_guest)
...
@include('Assistance::frontend.layouts.details.specs')
