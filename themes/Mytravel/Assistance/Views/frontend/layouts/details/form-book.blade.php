...
                            <div>{{ format_money($row->price_per_hour) }}<small>{{ __("/por hora") }}</small></div>
                            <div>{{ format_money($row->price_per_day) }}<small>{{ __("/por dia") }}</small></div>
                        </span>
                    </div>
                </div>
                <div class="nav-enquiry" v-if="is_form_enquiry_and_book">
                    <div class="enquiry-item active" >
                        <span>{{ __("Reservar") }}</span>
                    </div>
...
                                    <label>{{__("Retorno no mesmo dia")}}</label>
                                </div>
                                <div class="mb-0">
                                    <div class="pb-2">
...
                                </div>
                                <div class="d-block text-gray-1 font-weight-normal mb-0 text-left">
                                    <label>{{__("Retorno em outro dia")}}</label>
                                </div>
                                <div class="mb-4">
...
                                </div>
                            </div>
                            <span class="d-block text-gray-1 font-weight-normal mb-0 text-left">{{ __("Selecionar Datas") }}</span>
                            <div class="mb-4">
...
@include("Booking::frontend.global.enquiry-form",['service_type'=>'assistance'])