    ...
    <div class="container">
        <nav class="py-3" aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter mb-0 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="{{url('')}}">{{__('Inicio')}}</a></li>
    ...
    <div class="mb-4 mb-lg-8">
        <div class="container">
            <div class="position-relative">
                ...
                <div class="position-absolute video-gallery" style="bottom: 10px;right: 7px;"> 
                    <div class="flex-horizontal-center">
                        ...
                        @if($key === 0)
                        <a class="travel-fancybox btn btn-white transition-3d-hover ml-2 py-2 px-md-4 px-3 shadow-6" href="javascript:;" data-src="{{$item['large']}}" data-fancybox="gallery_assistance" data-caption="{!! clean($translation->title) !!} - #{{ $key }}" data-speed="700">
                            <i class="flaticon-gallery mr-md-2 font-size-18 text-primary"></i><span class="d-none d-md-inline">{{ __("Galeria") }}</span>
                        </a>
                        @else
                        <img class="travel-fancybox d-none" alt="Image Description" data-fancybox="gallery_assistance" data-src="{{$item['large']}}" data-caption="{!! clean($translation->title) !!} - #{{ $key }}" data-speed="700">
                        @endif
                        @endforeach
                        @endif
                    </div>
