<div class="bravo-list-assistance product-card-block product-card-v2 border-bottom border-color-8">
    <div class="container space-1">
        @if(!empty($title))
            <div class="d-flex justify-content-between mb-3 pt-md-3 mt-1 pb-md-3 mb-md-2 align-items-end">
                ...
                <a href="{{ route("assistance.search") }}" class="font-weight-bold d-flex text-lh-1 mb-md-2 ml-2">{{ __("Mais") }}
