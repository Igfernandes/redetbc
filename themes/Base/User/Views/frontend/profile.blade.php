        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <select name="religion" class="form-control">
                    ...
                    <option @if((old('sex',$dataUser->sex ?? '')) == "MASCULINE") selected @endif value="MASCULINE">MASCULINE</option>
                    <option @if((old('sex',$dataUser->sex ?? '')) == "FEMININE") selected @endif value="FEMININE">FEMININE</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="religion" class="form-control">
                    <option value="">{{__('-- Select --')}}</option>
                    <option @if((old('religion',$dataUser->religion ?? '')) == "CATHOLIC") selected @endif value="CATHOLIC">CATHOLIC</option>
                    <option @if((old('religion',$dataUser->religion ?? '')) == "EVANGELICAL") selected @endif value="EVANGELICAL">EVANGELICAL</option>
                    <option @if((old('religion',$dataUser->religion ?? '')) == "BOTH") selected @endif value="BOTH">BOTH</option>
                </select>
            </div>
            <div class="form-group">
