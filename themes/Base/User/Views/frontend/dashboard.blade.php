...
<div class="bravo-user-dashboard">
    <div class="row dashboard-price-info row-eq-height">
        ...
        <div class="col-lg-3 col-md-3 my-2">
            <div class="dashboard-item px-2" style="background-color: {{$item['color']}};">
                <div class="wrap-box">
                    <div class="title" style="font-size: 1.5rem; color: white;">
                        {{$item['title']}}
                    </div>
                    <div class="details">
                        <div class="number" style="font-size: 1.6rem; color: white;">
                            {{ $item['amount'] }}
                        </div>
                    </div>
                    <div class="desc" style="color: white;"> {{ $item['desc'] }}</div>
                </div>
            </div>
        </div>
        @endforeach
...
<div class="bravo-user-chart">
    ...
    <script>
        var earning_chart_data = {
            !!json_encode($earning_chart_data) !!
        };
    </script>
</div>
@endsection
                ...
                options: {
                    ...
                    scales: {
                        ...
                        yAxes: [{
                            ...
                            scaleLabel: {
                                display: true,
                                labelString: '{{__("Currency: :currency_main",['
                                currency_main '=>setting_item('
                                currency_main ')])}}'
                            },
                            ticks: {
                                beginAtZero: true,
