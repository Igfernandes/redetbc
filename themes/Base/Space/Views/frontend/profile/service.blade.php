...
@if(!empty($services) and $services->total())
    <div class="bravo-profile-list-services">
        @include('Space::frontend.blocks.list-space.index', ['rows'=>$services,'style_list'=>'normal','desc'=>' ','title'=>!empty($view_all) ? __('Espaço por :name',['name'=>$user->first_name]) :'','col'=>4])
