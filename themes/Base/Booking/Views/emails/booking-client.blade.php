        ...
        <tbody>
            <tr>
                <td style="padding: 35px;border-bottom: 10px solid #ececec;">
                    <div>
                        <span style="color: #0060fe;">{{ __('Mensagem do anunciante') }}</span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div>
                            <p style="font-size: 1.1rem;margin: 0;">{{ $vendor['name'] }}</p>
                            <span style="font-size: .9rem;color: gray;">{{ \Carbon\Carbon::now()->format('d/m/Y \à\s H:i') }}h</span>
                        </div>
                    </div>
                </td>
            </tr>
                ...
                <td style="text-align: center;border-bottom: 10px solid #ececec;padding: 35px 0;">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <span style="color: gray;font-size: 1.2rem;">{{ $vendor['phone'] }}</span>
                        </div>
                    </div>
                </td>
            </tr>
