            ...
            <div class="row booking-success-notice">
                <div class="col-lg-8 col-md-8">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="notice-success">
                            ...
                            <p class="line2">{{__('Detalhes da reserva foram enviados para:')}} <span>{{$booking->email}}</span></p>
                ...
                <div class="col-lg-4 col-md-4">
                    <ul class="booking-info-detail">
                        <li><span>{{__('Número da Reserva')}}:</span> {{$booking->id}}</li>
            ...
            <div class="row booking-success-detail">
                <div class="col-md-8">
                    ...
                    <div class="text-center">
                        <a href="{{route('user.booking_history')}}" class="btn btn-primary">{{__('Minhas Reservas')}}</a>
                    </div>
                </div>
                <div class="col-md-4">
