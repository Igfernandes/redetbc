...
<p>This document was last updated on October 6, 2020</p>';
        ...
        $settings = [
            ...
            [
                'name'  => "booking_enquiry_for_assistance",
                'val'   => "1",
                'group' => "enquiry",
            ],
            [
                'name'  => "booking_enquiry_type_assistance",
                'val'   => "booking_and_enquiry",
                'group' => "enquiry",
            ],
            [
        ...
        return  array(
            ...
            array(
                ...
                'children'   => array(
                    ...
                    array(
                        'name'       => 'Assistance Map',
                        'url'        => $locale . '/assistance?_layout=map',
                        'item_model' => 'custom',
                        'model_name' => 'Custom',
                        'children'   => array(),
                    ),
                    array(
                        ...
                        'url'        => $locale . '/assistance/blue-moon-yc-300',
                        'item_model' => 'custom',
                        'model_name' => 'Custom',
                        'children'   => array(),
                    ),
