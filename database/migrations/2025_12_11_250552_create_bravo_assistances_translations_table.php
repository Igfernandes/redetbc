...
return new class extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('bravo_assistance_translations')) {
            Schema::create('bravo_assistance_translations', function (Blueprint $table) {
                ...
                // índices
                $table->unique(['origin_id', 'locale'], 'bravo_assistance_translations_origin_id_locale_unique');
                $table->index('slug', 'bravo_assistance_translations_slug_index');
            });
        }
    }
