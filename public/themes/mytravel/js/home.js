...
jQuery(function ($) {
            ...
            success: function (data) {
                ...
                if (redirect.trim("/")) {
                    window.location.href =
                        bookingCore.url +
                        form.find("input[name=redirect]").val();
                } else {
            ...
            $.extend(true, {}, conf, {
                beforeShow: function (instance, slide) {
                    var $fancyModal = $(instance.$refs.container),
                        ...
                        animateIn =
                            instance.current.opts.$orig[0].dataset.animateIn,
                        animateOut =
                            instance.current.opts.$orig[0].dataset.animateOut,
                        speed = instance.current.opts.$orig[0].dataset.speed,
                        overlayBG =
                            instance.current.opts.$orig[0].dataset.overlayBg,
                        overlayBlurBG =
    ...
    window.travel_slick_carousel = function ($this) {
        ...
        var id = $this.attr("id"),
            ...
            setResponsive =
                $this.attr("data-responsive") != undefined
    ...
    if ($(".travel-inline-video-player").length) {
        ...
        function youTubeAPIReady() {
            ...
            DOMfirstScriptTag.parentNode.insertBefore(
                YTScriptTag,
                DOMfirstScriptTag
            );
        }
