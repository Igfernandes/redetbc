...
jQuery(function ($) {
                ...
                onSelect: function (files) {
                    ...
                    if (typeof files != "undefined" && files.length) {
                        ...
                        for (var i = 0; i < files.length; i++) {
                            ids.push(files[i].id);
                            html +=
                                '<div class="image-item"><div class="inner"><span class="delete btn btn-sm btn-danger"><i class="fa fa-trash"></i></span><img src="' +
                                files[i].thumb_size +
                                '"/></div></div>';
                        }
    ...
    $(".bravo_user_profile .bravo-list-item .control-action .btn-danger").on(
        "click",
        function () {
    ...
    $(".bravo_user_profile .bravo-list-item .control-action .btn-recovery").on(
        "click",
        function () {
            var c = confirm($(this).data("confirm"));
            if (!c) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.data) {
                        ...
                        lists.classList.remove("loading");
                    }
                },
                error: function (e) {
