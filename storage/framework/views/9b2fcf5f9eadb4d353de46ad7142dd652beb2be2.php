...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(!empty($recovery) ? __('Recuperação') : __("Todos os Eventos")); ?></h1>
            <div class="title-actions">
                <?php if(empty($recovery)): ?>
                <a href="<?php echo e(route('event.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Adicionar novo evento")); ?></a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="text-right">
            <p><i><?php echo e(__('Encontrados :total itens',['total'=>$rows->total()])); ?></i></p>
        </div>
            ...
            <div class="panel-body">
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php if($rows->total() > 0): ?>
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($row->status); ?>">
                                    <td>
                                        <input type="checkbox" name="ids[]" class="check-item" value="<?php echo e($row->id); ?>">
                                    </td>
                                    <td class="title">
                                        <?php if($row->is_featured): ?>
                                            <span class="badge badge-primary"><?php echo e(__("Destaque")); ?></span>
                                        <?php endif; ?>
                                    ...
                                    <td>
                                        <?php if(empty($recovery)): ?>
                                            <a href="<?php echo e(route('event.admin.edit',['id'=>$row->id])); ?>" class="btn btn-primary btn-sm">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7"><?php echo e(__("Nenhum evento encontrado")); ?></td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Event/Views/admin/index.blade.php ENDPATH**/ ?>