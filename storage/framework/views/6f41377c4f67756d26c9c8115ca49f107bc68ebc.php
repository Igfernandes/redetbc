...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input type="checkbox" name="wifi_available" <?php if($row->wifi_available): ?> checked <?php endif; ?> value="1"> <?php echo e(__("Habilitar destaque")); ?>

        </div>
    </div>
</div>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Tour/Views/admin/tour/extra_mytravel.blade.php ENDPATH**/ ?>