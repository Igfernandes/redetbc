...
<h2 class="title-bar">
    <?php echo e(__("Dados de verificação")); ?>
...
<div class="booking-history-manager">
    <form action="<?php echo e(route('user.verification.store')); ?>" method="post">
        ...
        <?php break; ?>
        <?php case ("upload-image"): ?>
        <?php echo $__env->make('User::frontend.verification.fields.upload-image', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php break; ?>
        <?php case ("file"): ?>
        ...
        <?php break; ?> 
        <?php case ("select"): ?>
        <?php echo $__env->make('User::frontend.verification.fields.select', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php break; ?>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <button class="btn btn-success"> <i class="fa fa-save"></i>&nbsp;&nbsp; <?php echo e(__("Salvar alterações")); ?> </button>
            </div>
        </div>
    </form>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo e(__('Verificar Telefone')); ?></h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="verifyPhone()" class="btn btn-primary"><?php echo e(__('Verificar')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Base/User/Views/frontend/verification/update.blade.php ENDPATH**/ ?>