		...
		<div class="mb-4">
			<div class="input-group border-bottom border-width-2 border-color-1 py-2">
				...
				<div class="smart-search border-0 p-0 form-control  height-40">
					<input type="text" class="smart-search-location parent_text  font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0" <?php echo e(( empty(setting_item("event_location_search_style")) or setting_item("event_location_search_style") == "normal" ) ? "readonly" : ""); ?> placeholder="<?php echo e(__("Onde você está indo?")); ?>" value="<?php echo e($location_name); ?>" data-onLoad="<?php echo e(__("Carregando...")); ?>"
...
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Event/Views/frontend/layouts/search/fields/location.blade.php ENDPATH**/ ?>