<div class="bravo_filter navbar-expand-lg navbar-expand-lg-collapse-block">
    ...
    <div id="sidebar" class="navbar-expand-lg navbar-expand-lg-collapse-block collapse">
        ...
        <div class="item pb-4 mb-2">
            <?php echo $__env->make('Assistance::frontend.layouts.search.form-search-vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        
        <div class="item pb-4 mb-2">
            <a href="<?php echo e(route("assistance.search",['_layout'=>'map'])); ?>" class="d-block border border-color-1 rounded-xs">
                <img src="<?php echo e(url("/themes/mytravel/images/map.jpg")); ?>" alt="" width="100%">
            </a>
        </div>
        <form action="<?php echo e(url(app_get_locale(false,false,'/').config('assistance.assistance_route_prefix'))); ?>" class="bravo_form_filter">
            <?php if( !empty(Request::query('location_id')) ): ?>
            <input type="hidden" name="location_id" value="<?php echo e(Request::query('location_id')); ?>">
            <?php endif; ?>
            <div class="form-group">
                <label class="control-label"><?php echo e(__("Religion")); ?></label>
                <select name="religion" class="form-control">
                    <option value="">Selecione a religião</option>
                    <option value="CATHOLIC" <?php if(Request::query('location_id')=="CATHOLIC" ): ?> selected <?php endif; ?>> <?php echo e(__("Evangelical")); ?></option>
                    <option value="EVANGELICAL" <?php if(Request::query('location_id')=="EVANGELICAL" ): ?> selected <?php endif; ?>> <?php echo e(__("Catholic")); ?></option>
                    <option value="BOTH" <?php if(Request::query('location_id')=="BOTH" ): ?> selected <?php endif; ?>> <?php echo e(__("Both")); ?></option>
                </select>
            </div>
            ...
            <div class="sidenav border border-color-8 rounded-xs">
                <div id="bravo-filter-price" class="accordion shadow-none bravo-filter-price border-bottom">
                    ...
                    $price_max = $pri_to = ceil(App\Currency::convertPrice($assistance_min_max_price[1]));
                        ...
                        <div class="card-collapse">
                            <h3 class="mb-0">
                                <button type="button" class="btn btn-link btn-block card-btn py-2  text-lh-3 collapsed" data-toggle="collapse" data-target="#review_score">
                                    <span class="row align-items-center">
                                        <span class="col-9">
                                            <span class="d-block font-size-lg-15 font-size-17 font-weight-bold text-dark text-lh-1dot4"><?php echo e(__("Pontuação da avaliação")); ?></span>
                                        </span>
                                        <span class="col-3 text-right">
                                            <span class="card-btn-arrow">
                                                <span class="fa fa-chevron-down small"></span>
                            ...
                            <div class="card-body pt-0 mt-1  pb-4">
                                ...
                                <?php if($key <= 2 ): ?>
                                    ...
                                    <div class="form-group d-flex align-items-center justify-content-between font-size-1 text-lh-md text-secondary mb-3">
                                        ...
                                        <span><?php echo e($term->assistance_count??0); ?></span>
                                    </div>
                                    <?php endif; ?>
...
</div><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Assistance/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>