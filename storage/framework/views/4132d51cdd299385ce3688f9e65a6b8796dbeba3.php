            ...
            <div class="row justify-content-xl-between">
                ...
                <div class="col-12 col-md-6 col-lg col-xl-3dot1">
                    ...
                    <div class="mb-4 mb-xl-2">
                        ...
                        <h4 class="h6 font-weight-bold mb-2 mb-xl-4"><?php echo e(__('Lista de e-mails')); ?></h4>

                        <p class="m-0 text-gray-1"><?php echo e(__('Inscreva-se na nossa lista de e-mails para receber as últimas novidades e ofertas.')); ?></p>
...
<?php \App\Helpers\ReCaptchaEngine::scripts() ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Layout/parts/footer.blade.php ENDPATH**/ ?>