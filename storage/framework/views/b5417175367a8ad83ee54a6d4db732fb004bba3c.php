...
<form action="<?php echo e(route('user.admin.verification.store',['id'=>$row->id])); ?>" method="post" class="needs-validation" novalidate>
    ...
    <div class="container">
        <div class="d-flex justify-content-between mb20">
            <div class="">
                <h1 class="title-bar"><?php echo e($row->id ? __('Solicitação de Verificação: ').$row->getDisplayName() : __('Adicionar novo usuário')); ?></h1>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="panel">
                    <div class="panel-title"><strong><?php echo e(__('Dados')); ?></strong></div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th><?php echo e(__('Não')); ?></th>
                                        <th><?php echo e(__("Informação")); ?></th>
                                        <th width="200px"><?php echo e(__("Marcar como verificado")); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <div class="d-flex justify-content-between">
            <span></span>
            <button class="btn btn-primary" type="submit"><?php echo e(__('Salvar Alteração')); ?></button>
        </div>
    </div>
</form>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/User/Views/admin/verification/detail.blade.php ENDPATH**/ ?>