        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    <?php if($row->slug): ?>
                        <p class="item-url-demo"><?php echo e(__("Link permanente")); ?>: <?php echo e(url( (request()->query('lang') ? request()->query('lang').'/' : '').config('location.location_route_prefix'))); ?>/<a href="#" class="open-edit-input" data-name="slug"><?php echo e($row->slug); ?></a></p>
                    <?php endif; ?>
                </div>
                <div class="">
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-sm" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>" target="_blank"><?php echo e(__("Visualizar")); ?></a>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                <h3 class="panel-body-title"><?php echo e(__("Conteúdo da Localização")); ?></h3>
                                ...
                                <?php if(is_default_lang()): ?>
                                    ...
                                    <div class="form-group form-index-hide">
                                        <label class="control-label"><?php echo e(__("A coordenada geográfica")); ?></label>
                                        <div class="control-map-group">
                                            <div id="map_content"></div>
                                            <div class="g-control">
                                                <div class="form-group">
                                                    <label><?php echo e(__("Latitude do Mapa")); ?>:</label>
                                                    <input type="text" name="map_lat" class="form-control" value="<?php echo e($row->map_lat); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label><?php echo e(__("Longitude do Mapa")); ?>:</label>
                                                    <input type="text" name="map_lng" class="form-control" value="<?php echo e($row->map_lng); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label><?php echo e(__("Zoom do Mapa")); ?>:</label>
                                ...
                                <div class="form-group-item">
                                    <label class="control-label"><?php echo e(__('Ideias de Viagem')); ?></label>
                                    <div class="g-items-header">
                                        <div class="row">
                                            <div class="col-md-2"><?php echo e(__('Imagem')); ?></div>
                                            <div class="col-md-4"><?php echo e(__("Título/Link")); ?></div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Location/Views/admin/detail.blade.php ENDPATH**/ ?>