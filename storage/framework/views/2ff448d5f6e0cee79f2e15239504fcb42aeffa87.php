...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__('Todas Páginas')); ?></h1>
            <div class="title-actions">
                <a href="<?php echo e(route('page.admin.create')); ?>" class="btn btn-primary"><?php echo e(__('Adicionar nova página')); ?></a>
            </div>
        </div>
        ...
        <div class="filter-div d-flex justify-content-between ">
            ...
            <div class="col-left">
               <form method="get" action="<?php echo e(route('page.admin.index')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                    <input  type="text" name="page_name" value="<?php echo e(Request()->page_name); ?>" placeholder="<?php echo e(__('Pesquisar por nome')); ?>" class="form-control">
                    <button class="btn-info btn btn-icon btn_search"  type="submit"><?php echo e(__('Buscar Página')); ?></button>
                </form>
            </div>
        </div>
        <div class="panel">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a href="<?php echo e(route('page.admin.edit',['id'=>$row->id])); ?>" class="dropdown-item"><i class="fa fa-edit"></i> <?php echo e(__('Editar')); ?></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Page/Views/admin/index.blade.php ENDPATH**/ ?>