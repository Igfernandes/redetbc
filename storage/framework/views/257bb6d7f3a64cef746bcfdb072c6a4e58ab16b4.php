<?php if(!empty($location_category) and $location_category->count() > 0): ?>
    <div class="panel">
        <div class="panel-title"><strong><?php echo e(__("Arredores")); ?></strong></div>
                ...
                <?php $__currentLoopData = $location_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-group-item">
                        ...
                        <div class="g-items-header">
                            <div class="row">
                                <div class="col-md-3"><?php echo e(__("Nome")); ?></div>
                                <div class="col-md-3"><?php echo e(__('Descrição')); ?></div>
                                <div class="col-md-3"><?php echo e(__('Distância')); ?></div>
                                ...
                                <?php $__currentLoopData = $surroundingItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item" data-number="<?php echo e($key); ?>">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text"
                                                       name="surrounding[<?php echo e($category->id); ?>][<?php echo e($key); ?>][name]"
                                                       class="form-control"
                                                       value="<?php echo e(@$item['name']); ?>"
                                                       placeholder="<?php echo e(__('Praia Ens Solarada')); ?>">
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-2">
                                                <select name="surrounding[<?php echo e($category->id); ?>][<?php echo e($key); ?>][type]"
                                                        class="form-control">
                                                    <option <?php if($item['type']=='m'): ?> selected <?php endif; ?> value="m"><?php echo e(__('m')); ?></option>
                                                    <option <?php if($item['type']=='km'): ?> selected <?php endif; ?> value="km"><?php echo e(__('Km')); ?></option>
                                                </select>
                                            </div>
                                            <div class="col-md-1">
                        ...
                        <div class="g-more hide">
                            <div class="item" data-number="__number__">
                                <div class="row">
                                    <div class="col-md-3">
                                        <input type="text"
                                               __name__="surrounding[<?php echo e($category->id); ?>][__number__][name]"
                                               class="form-control"
                                               placeholder="<?php echo e(__('Praia Ens Solarada')); ?>">
                                    </div>
                                    <div class="col-md-3">
...
<?php endif; ?>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Hotel/Views/admin/hotel/surrounding.blade.php ENDPATH**/ ?>