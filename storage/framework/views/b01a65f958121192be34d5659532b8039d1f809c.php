...
<?php if(is_default_lang()): ?>
    <div class="form-group">
        ...
        <small>
            <?php echo e(__("A posição será utilizada para ordenar na busca da página Filtro. O maior número tem prioridade")); ?>

        </small>
    </div>
    <div class="form-group">
        <label><?php echo e(__("Exibir tipo de serviço em detalhes")); ?></label>
        <select name="display_type" class="form-control">
            <option  <?php if($row->display_type == "icon_left"): ?> selected <?php endif; ?> value="icon_left"><?php echo e(__("Exibir ícone à esquerda")); ?></option>
            <option  <?php if($row->display_type == "icon_center"): ?> selected <?php endif; ?> value="icon_center"><?php echo e(__("Ícone do centro de exibição")); ?></option>
        </select>
    </div>
    <div class="form-grou">
...
<?php endif; ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Event/Views/admin/attribute/form.blade.php ENDPATH**/ ?>