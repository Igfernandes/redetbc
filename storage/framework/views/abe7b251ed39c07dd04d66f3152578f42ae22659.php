...
<form action="<?php echo e(route('page.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
    ...
    <div class="container">
        <div class="d-flex justify-content-between mb20">
            <div class="">
                <h1 class="title-bar"><?php echo e($row->id ? __('Editar: ') .$translation->title :  __('Adicionar nova página')); ?></h1>
                <?php if($row->slug): ?>
                ...
                <div class="col-md-9">
                    <div class="panel">
                        <div class="panel-title">
                            <strong><?php echo e(__('Página Content')); ?></strong>
                        </div>
                        <div class="panel-body">
                            <div class="form-group magic-field" data-id="title" data-type="title">
                                ...
                                <input
                                    ...
                                    placeholder="<?php echo e(__("Título")); ?>"
                                    name="title"
                                    class="form-control">
                            </div>
                            ...
                            <div class="form-group magic-field" data-id="content" data-type="content">
                                ...
                                <div class="">
                                    <textarea
                                        ...
                                        id="content"
                                        cols="30"
                                        rows="10"><?php echo e($translation->content); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Page/Views/admin/detail.blade.php ENDPATH**/ ?>