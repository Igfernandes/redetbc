            ...
            <?php $__currentLoopData = $translation->itinerary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$itinerary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item" data-number="<?php echo e($key); ?>">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="itinerary[<?php echo e($key); ?>][title]" class="form-control" value="<?php echo e($itinerary['title'] ?? ""); ?>" placeholder="<?php echo e(__('Título: Day 1')); ?>">
    ...
    <div class="g-more hide">
        <div class="item" data-number="__number__">
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="text" __name__="itinerary[__number__][title]" class="form-control" placeholder="<?php echo e(__('Título: Day 1')); ?>">
...
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Tour/Views/admin/tour/itinerary.blade.php ENDPATH**/ ?>