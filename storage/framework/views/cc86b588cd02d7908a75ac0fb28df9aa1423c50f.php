...
<div class="header-widgets d-flex flex-grow-1">
    ...
    <div class="widgets-left d-flex flex-grow-1 align-items-center">
        ...
        <div class="header-widget search-widget">
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn btn-link" target="_blank"><i class="fa fa-eye"></i> <span translate="no"><?php echo e(__('Inicio')); ?> </span>
    ...
    <div class="widgets-right flex-shrink-0 d-flex">
        ...
        <div class="dropdown header-widget widget-user flex-shrink-0">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="<?php echo e(route('user.admin.detail',['id'=>$user->id])); ?>"><?php echo e(__('Editar Perfil')); ?></a>

                <a class="dropdown-item" href="<?php echo e(route('user.admin.password',['id'=>$user->id])); ?>"><?php echo e(__('Alterar Senha')); ?></a>

                <div class="dropdown-divider"></div>

                <h6 class="dropdown-header"><?php echo e(__("Fornecedor Painel")); ?></h6>

                <a href="<?php echo e(route('vendor.dashboard')); ?>" class="dropdown-item"><?php echo e(__("Painel")); ?></a>
