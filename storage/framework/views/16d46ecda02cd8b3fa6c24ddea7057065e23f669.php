                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="form-content dropdown-toggle" data-toggle="dropdown">
                            <label class="form-label"><?php echo e(__('Hospedes')); ?></label>
                            <div class="render">
                                <span class="adults" >
                                    <span class="one" >{{adults}}
                                        <span v-if="adults < 2"><?php echo e(__('Adulto')); ?></span>
                                        <span v-else><?php echo e(__('Adultos')); ?></span>
                                    </span>
                                </span>
                                -
                                <span class="children" >
                                    <span class="one" >{{children}}
                                        <span v-if="children < 2"><?php echo e(__('Criança')); ?></span>
                                        <span v-else><?php echo e(__('Crianças')); ?></span>
                                    </span>
                                </span>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-btn">
                    <div class="g-button-submit">
                        <button class="btn btn-primary btn-search" @click="checkAvailability" :class="{'loading':onLoadAvailability}" type="submit">
                            <?php echo e(__("Verificar Disponibilidade")); ?>
            ...
            <div class="row row_extra_service" v-if="extra_price.length">
                <div class="col-md-12">
                    <div class="form-section-group">
                        <label><?php echo e(__('Preços extras:')); ?></label>
                        <div class="row">
...
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Hotel/Views/frontend/layouts/details/hotel-rooms.blade.php ENDPATH**/ ?>