...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Gerenciamento de solicitações de pagamento")); ?></h1>
        </div>
        <?php echo $__env->make('admin.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                    <label ><?php echo e(__("Selecionado com")); ?></label>
                    <div  class="filter-form filter-form-left d-flex justify-content-start">
                        <button class="btn-info btn btn-icon dungdt-form-payout-btn" type="button"><?php echo e(__('Selecionar Ação')); ?></button>
            ...
            <div class="col-left">
                <form method="get" action="<?php echo e(route('vendor.admin.payout.index')); ?> " class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    <?php if(!empty($rows)): ?>
                        ...
                        ?>
                    <?php endif; ?>
                    <input type="text" name="s" value="<?php echo e(Request()->s); ?>" placeholder="<?php echo e(__('Busque pelo id do pagamento')); ?>" class="form-control">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th> <?php echo e(__('Fornecedor')); ?></th>
                                <th><?php echo e(__("Note")); ?></th>
                                <th width="200px"> <?php echo e(__('Quantidade')); ?></th>
                                <th width="230px"> <?php echo e(__('Método de Pagamento')); ?></th>
                                <th width="130px"> <?php echo e(__('Criado em')); ?></th>
                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payout): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="status-<?php echo e($payout->status); ?>">
                                        ...
                                        <td>
                                            <a class="btn btn-info edit-payout-btn" href="#" onclick="return false"><i class="fa fa-edit"></i> <?php echo e(__("Editar")); ?></a>
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success dungdt-form-payout-save"><?php echo e(__('Salvar alterações')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Vendor/Views/admin/payouts/index.blade.php ENDPATH**/ ?>