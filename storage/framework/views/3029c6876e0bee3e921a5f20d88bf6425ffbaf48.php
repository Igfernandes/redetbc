<?php if(is_default_lang()): ?>
    <div class="panel">
        <div class="panel-title"><strong><?php echo e(__('Horário de check-in/check-out')); ?></strong></div>
        <div class="panel-body">
            <div class="form-group d-none">
                <label><?php echo e(__('Permitir reserva para o dia inteiro')); ?></label>
                <br>
                <label>
                    <input type="checkbox" name="allow_full_day" <?php if($row->allow_full_day): ?> checked <?php endif; ?> value="1"> <?php echo e(__("Ativar reserva para o dia inteiro")); ?>

                </label>
                <div class="small">
                    <?php echo e(__("Você pode reservar o quarto por dia inteiro")); ?> <br>
                    <?php echo e(__("Ex: reserva de 22 a 23, então os dias 22 e 23 ficam completos e outras pessoas não podem reservar")); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label><?php echo e(__('Horário do check-in')); ?></label>
                        <input type="text" value="<?php echo e($row->check_in_time); ?>" placeholder="<?php echo e(__("Ex: 12:00AM")); ?>" name="check_in_time" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label><?php echo e(__('Horário do check-out')); ?></label>
                        <input type="text" value="<?php echo e($row->check_out_time); ?>" placeholder="<?php echo e(__("Ex: 11:00AM")); ?>" name="check_out_time" class="form-control">
                    </div>
                </div>
            </div>
            <?php if(is_default_lang()): ?>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="control-label"><?php echo e(__("Mínimo de dias de antecedência")); ?></label>
                            ...
                            <i><?php echo e(__("Deixe em branco se não precisar usar opção de mínimo de dias")); ?></i>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="control-label"><?php echo e(__("Mínimo de dias de estadia")); ?></label>
                            ...
                            <i><?php echo e(__("Deixe em branco se não precisar definir mínimo de dias de estadia")); ?></i>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <div class="panel">
        <div class="panel-title"><strong><?php echo e(__("Preço")); ?></strong></div>
        <div class="panel-body">
            <?php if(is_default_lang()): ?>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price" class="form-control" value="<?php echo e($row->price); ?>" placeholder="<?php echo e(__("Preço do hotel")); ?>">
                        </div>
                    </div>
                    <div class="col-lg-6 d-none">
                        <div class="form-group">
                            <label class="control-label"><?php echo e(__("Preço promocional")); ?></label>
                            <input type="number" step="any" name="sale_price" class="form-control" value="<?php echo e($row->sale_price); ?>" placeholder="<?php echo e(__("Preço promocional do hotel")); ?>">
                            <span><i><?php echo e(__("Se o preço normal for menor que o promocional, será exibido o preço normal")); ?></i></span>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
                            ...
                            <div class="col-md-5">
                                <?php if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale')): ?>
                                    <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="g-lang">
                                            <div class="title-lang"><?php echo e($language->name); ?></div>
                                            <input type="text" __name__="extra_price[__number__][name<?php echo e($key); ?>]" class="form-control" placeholder="<?php echo e(__('Nome do preço extra')); ?>">
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                ...
                                <div class="col-md-5">
                                    <?php if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale')): ?>
                                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="g-lang">
                                                <div class="title-lang"><?php echo e($language->name); ?></div>
                                                <input type="text" __name__="service_fee[__number__][name<?php echo e($key); ?>]" class="form-control" placeholder="<?php echo e(__('Nome da taxa')); ?>">
                                                <input type="text" __name__="service_fee[__number__][desc<?php echo e($key); ?>]" class="form-control" placeholder="<?php echo e(__('Descrição da taxa')); ?>">
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
...
<?php endif; ?>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Hotel/Views/admin/hotel/pricing.blade.php ENDPATH**/ ?>