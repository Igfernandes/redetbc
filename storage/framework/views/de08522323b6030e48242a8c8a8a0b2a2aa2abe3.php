                ...
                <form action="" class="bravo-form-item">
                    <table class="table table-hover bravo-list-item">
                        ...
                        <tr>
                            ...
                            <th width="120px"><?php echo e(__('Status')); ?></th>
                            <th width="220px"><?php echo e(__('Criado em')); ?></th>
                        ...
                        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li><?php echo e(__("Nome:")); ?> <?php echo e($row->first_name); ?> <?php echo e($row->last_name); ?> </li>
                                        <li><?php echo e(__("Email:")); ?> <?php echo e($row->email); ?></li>
                                        <li><?php echo e(__("Celular:")); ?> <?php echo e($row->phone); ?></li>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="d-flex justify-content-center"><?php echo e(__("Carregando...")); ?></div>
                            </div>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        $('.btn-detail-booking').on('click',function (e){
            ...
            $(this).find('.modal-body').html('<div class="d-flex justify-content-center"><?php echo e(__("Carregando...")); ?></div>');
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Report/Views/admin/booking/index.blade.php ENDPATH**/ ?>