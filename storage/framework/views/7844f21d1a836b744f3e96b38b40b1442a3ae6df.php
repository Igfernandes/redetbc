<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title"><?php echo e(__('E-mail de configuração')); ?></h3>
        <p class="form-group-desc"><?php echo e(__('Alterar a configuração do seu site de e-mail')); ?></p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <?php if(is_default_lang()): ?>
                    <div class="form-group">
                        <label><?php echo e(__('Driver de e-mail')); ?></label>
                    ...
                    <div data-operator="or" data-condition="email_driver:is(smtp),email_driver:is(sendmail),email_driver:is(mailgun),email_driver:is(postmark),email_driver:is(ses),email_driver:is(sparkpost)">
                        ...
                        <div data-operator="or" data-condition="email_driver:is(smtp),email_driver:is(sendmail)">
                            <div class="form-group">
                                <label><?php echo e(__('Anfitrião de e-mail')); ?></label>
                                <div class="form-controls">
                        ...
                        <div data-condition="email_driver:is(mailgun)">
                            <div class="form-group">
                                <label class=""><?php echo e(__("Domínio Mailgun")); ?></label>
                                <div class="form-controls">
                            ...
                            <div class="form-group">
                                ...
                                <label class=""><?php echo e(__("Segredo da arma postal")); ?></label>
                                <div class="form-controls">
                            ...
                            <div class="form-group">
                                ...
                                <label class=""><?php echo e(__("Ponto final do Mailgun")); ?></label>
                                <div class="form-controls">
                        ...
                        <div data-condition="email_driver:is(postmark)">
                            <div class="form-group">
                                <label class=""><?php echo e(__("Símbolo de carimbo postal")); ?></label>
                                <div class="form-controls">
                        ...
                        <div data-condition="email_driver:is(sparkpost)">
                            <div class="form-group">
                                <label class=""><?php echo e(__("Segredo do Sparkpost")); ?></label>
                                <div class="form-controls">
                ...
                <?php else: ?>
                    <p><?php echo e(__('Você pode editar no idioma principal.')); ?></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php if(is_default_lang()): ?>
    ...
    <div class="row">
        <div class="col-sm-4">
            <h3 class="form-group-title"><?php echo e(__('E-mail da configuração')); ?></h3>
            <p class="form-group-desc"><?php echo e(__('Como seu cliente pode entrar em contato com você')); ?></p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label><?php echo e(__("E-mail do administrador")); ?></label>
                        <div class="form-controls">
                            <input type="email" class="form-control" name="admin_email" value="<?php echo e($settings['admin_email'] ?? ''); ?>">
                            <p><i><?php echo e(__("Você receberá todas as notificações deste e-mail")); ?></i></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label><?php echo e(__("Nome do formulário de e-mail")); ?></label>
                        <div class="form-controls">
                            <input type="text" class="form-control" name="email_from_name" value="<?php echo e($settings['email_from_name'] ?? ''); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label><?php echo e(__("Endereço do formulário de e-mail")); ?></label>
                        <div class="form-controls">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title"><?php echo e(__('Teste de e-mail')); ?></h3>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
                        <label class=""><?php echo e(__("E-mail")); ?></label>
                        <input type="email" class="form-control" id="to-email-testing" name="to_email_test"/>
                    </div>
                    <div class="form-controls">
                        <br>
                        <div id="email-testing" style="cursor: pointer;" class="btn btn-primary"><?php echo e(__('Enviar teste de e-mail')); ?></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-controls">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title"><?php echo e(__('Cabeçalho e rodapé de e-mail')); ?></h3>
        <p class="form-group-desc"><?php echo e(__('Alterar cabeçalho e rodapé do e-mail de reserva')); ?></p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    <label ><?php echo e(__("Cabeçalho")); ?></label>
                    <div class="form-controls">
                ...
                <div class="form-group">
                    <label ><?php echo e(__("Rodapé")); ?></label>
                    <div class="form-controls">
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Email/Views/admin/settings/email.blade.php ENDPATH**/ ?>