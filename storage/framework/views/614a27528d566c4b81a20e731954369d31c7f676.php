...
<?php if(!empty($booking_why_book_with_us)): ?>
    <div class="border border-color-7 rounded p-4 mb-5 mt-5">
        <h6 class="font-size-17 font-weight-bold text-gray-3 mx-1 mb-3 pb-1">
            <?php echo e(__("Por que reservar conosco?")); ?>
...
<?php endif; ?>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Booking/Views/frontend/booking/booking-why-book-us.blade.php ENDPATH**/ ?>