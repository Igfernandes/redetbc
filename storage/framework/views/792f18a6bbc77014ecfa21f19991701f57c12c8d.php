    ...
    <div class="container">
        <div class="row justify-content-center bravo-login-form-page bravo-login-page">
            <div class="col-md-5">
                ...
                <div class="">
                    <h4 class="form-title"><?php echo e(__('Entrar')); ?></h4>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\resources\views/auth/login.blade.php ENDPATH**/ ?>