...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Planos do Usuário")); ?></h1>
        </div>
        <?php echo $__env->make('admin.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    <div class="panel-title"><?php echo e(__("Adicionar Plano")); ?></div>
                        ...
                        <form class="bravo-form-item">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo e(__("Para Perfil")); ?></th>
                                    <th width="60px"><?php echo e(__("Preço")); ?></th>
                                    <th width="60px"><?php echo e(__("Preço Anual")); ?></th>
                                    <th width="60px"><?php echo e(__("Duração")); ?></th>
                                    <th width="60px"><?php echo e(__("Serviços Máx.")); ?></th>
                                    <th width="60px"><?php echo e(__("Status")); ?></th>
                                    <th width="60px"><?php echo e(__("Data")); ?></th>
                                    <th width="100px"></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class=""><?php echo e($row->price ? format_money($row->price) : __("Grátis")); ?></td>
                                        <td class=""><?php echo e($row->annual_price ? format_money($row->annual_price) : ''); ?></td>
                                        <td class=""><?php echo e($row->duration_text); ?></td>
                                        <td class=""><?php echo e($row->max_service ? $row->max_service : __('Ilimitado')); ?></td>
                                        ...
                                        <td class="title">
                                            <a href="<?php echo e(route('user.admin.plan.edit',['id'=>$row->id])); ?>" class="btn btn-default btn-sm"><i class="fa fa-edit"></i> <?php echo e(__("Editar")); ?></a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/User/Views/admin/plan/index.blade.php ENDPATH**/ ?>