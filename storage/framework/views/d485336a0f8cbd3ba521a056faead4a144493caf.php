    ...
    <form action="<?php echo e(route('tour.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->id ? __('Editar: ').$row->title : __('Adicionar novo passeio')); ?></h1>
                    <?php if($row->slug): ?>
                        <p class="item-url-demo"><?php echo e(__("Link permanente")); ?>: <?php echo e(url(config('tour.tour_route_prefix') )); ?>/<a href="#" class="open-edit-input" data-name="slug"><?php echo e($row->slug); ?></a>
                        </p>
                    <?php endif; ?>
                </div>
                <div class="">
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-sm" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>" target="_blank"><?php echo e(__("Visualizar Tour")); ?></a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="lang-content-box">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php if(is_default_lang()): ?>
                            <div class="panel">
                                <div class="panel-title"><strong><?php echo e(__("Passeio Destaque")); ?></strong></div>
                                <div class="panel-body">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="default_state" class="custom-select">
                                            <option value="1" <?php if(old('default_state',$row->default_state ?? -1) == 1): ?> selected <?php endif; ?>><?php echo e(__("Sempre disponível")); ?></option>
                                            <option value="0" <?php if(old('default_state',$row->default_state ?? -1) == 0): ?> selected <?php endif; ?>><?php echo e(__("Disponível apenas em datas específicas")); ?></option>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Tour/Views/admin/detail.blade.php ENDPATH**/ ?>