                                        ...
                                        <div class="flex-horizontal-center ml-2">
                                            ...
                                            <div class="ml-2 text-lh-1">
                                                <div class="ml-1">
                                                    ...
                                                    <span class="text-gray-1 font-size-12">(<?php echo e($review_score['total_review']); ?> <?php echo e($review_score['total_review'] > 1 ? __('Avaliações') : __('Avaliação')); ?>)</span>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                            ...
                            <div class="border border-color-7 rounded mb-5">
                                <div class="border-bottom">
                                    <?php if($row->discount_percent): ?>
                                        <div class="sale-box">
                                            <div class="ribbon ribbon--red"><?php echo e(__("SALVAR :text",['text'=>$row->discount_percent])); ?></div>
                                        </div>
                                    <?php endif; ?>
                                    <div class="p-4">
                                        ...
                                        <span class="font-size-24 text-gray-6 font-weight-bold ml-1">
                                            ...
                                            <span class="font-size-14"> / <?php echo e(__('Noite')); ?></span>
                                        </span>
                                    </div>
                                </div>
                                <div class="p-3">
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        var bravo_booking_data = <?php echo json_encode($booking_data); ?>
            ...
            name_required:'<?php echo e(__("Nome is Required")); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Hotel/Views/frontend/detail.blade.php ENDPATH**/ ?>