<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Conteúdo do Hotel")); ?></strong></div>
    <div class="panel-body">
        <div class="form-group magic-field" data-id="title" data-type="title">
            <label class="control-label"><?php echo e(__("Título")); ?></label>
            <input type="text" value="<?php echo clean($translation->title); ?>" placeholder="<?php echo e(__("Nome do hotel")); ?>" name="title" class="form-control">
        </div>
        ...
        <div class="form-group magic-field" data-id="content" data-type="content" data-editor="1">
            <label class="control-label" data-><?php echo e(__("Conteúdo")); ?></label>
            <div class="">
...
<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Política do Hotel")); ?></strong></div>
    <div class="panel-body">
        <?php if(is_default_lang()): ?>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label><?php echo e(__("Classificação do Hotel")); ?></label>
        ...
        <div class="form-group-item">
            <label class="control-label"><?php echo e(__('Política')); ?></label>
...
</div><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Hotel/Views/admin/hotel/content.blade.php ENDPATH**/ ?>