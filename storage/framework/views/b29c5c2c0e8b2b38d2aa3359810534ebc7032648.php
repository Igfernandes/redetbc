    ...
    <div class="position-relative">
        <div id="sliderSyncingNav" class="travel-slick-carousel u-slick mb-2"
            ...
            <?php $__currentLoopData = $row->getGallery(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="js-slide">
                    <img class="img-fluid border-radius-3" src="<?php echo e($item['large']); ?>" alt="<?php echo e(__("Galeria")); ?>">
                </div>
        ...
        <div id="sliderSyncingThumb" class="travel-slick-carousel u-slick u-slick--gutters-4 u-slick--transform-off"
            ...
            <?php $__currentLoopData = $row->getGallery(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="js-slide" style="cursor: pointer;">
                    <img class="img-fluid border-radius-3 height-110" src="<?php echo e($item['thumb']); ?>" alt="<?php echo e(__("Galeria")); ?>">
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
    ...
    <ul class="list-group list-group-borderless list-group-horizontal flex-center-between text-center mx-md-4 flex-wrap">
        <li class="list-group-item text-lh-sm ">
            ...
            <div class="text-gray-1">
                ...
                <?php echo e(__("Lista de desejos")); ?></div>
        </li>
        <?php if($row->start_time): ?>
            <li class="list-group-item text-lh-sm ">
                <i class="icofont-wall-clock text-primary font-size-50 mb-1 "></i>
                <div class="text-gray-1"> <?php echo e(__("Hora de entrada")); ?>: <?php echo e($row->start_time); ?></div>
            </li>
        <?php endif; ?>
        <?php if($row->duration): ?>
            <li class="list-group-item text-lh-sm ">
...
<?php if($row->map_lat && $row->map_lng): ?>
    <div class="mt-4">
        <h3 class="font-size-21 font-weight-bold text-dark mb-4"><?php echo e(__("Localização")); ?></h3>
...
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Event/Views/frontend/layouts/details/detail.blade.php ENDPATH**/ ?>