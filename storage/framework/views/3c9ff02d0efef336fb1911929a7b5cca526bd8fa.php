        ...
        <div class="row">
            <div class="col-md-2">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <strong>
                            <i class="fa fa-cogs"></i> <?php echo e(__("Configurações principais")); ?></strong>
                    </div>
            ...
            <div class="col-md-10">
                <form action="<?php echo e(route('core.admin.settings.store',['group'=>$current_group])); ?>" method="post" autocomplete="off">
                    ...
                    <div class="d-flex justify-content-between">
                        <span></span>
                        <button class="btn btn-primary" type="submit"><?php echo e(__('Salvar configurações')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Core/Views/admin/settings/index.blade.php ENDPATH**/ ?>