    ...
    <div class="container">
        ...
        <div class="right">
            <?php if($row->getBookingEnquiryType() === "book"): ?>
                <a class="btn btn-primary bravo-button-book-mobile"><?php echo e(__("Reserve agora")); ?></a>
            <?php else: ?>
                <a class="btn btn-primary" data-toggle="modal" data-target="#enquiry_form_modal"><?php echo e(__("Contacte-nos agora")); ?></a>
            <?php endif; ?>
        </div>
    </div>
</div>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Event/Views/frontend/layouts/details/form-book-mobile.blade.php ENDPATH**/ ?>