                    ...
                    <div class="col-md-4 mb-4 mb-md-0">
                        <div class="border rounded flex-content-center py-5 border-width-2">
                            <div class="text-center">
                                ...
                                <div class="text-gray-1"><?php echo e(__("De")); ?>

                                    <?php if($review_score['total_review'] > 1): ?>
                                        <?php echo e(__(":number avaliações",["number"=>$review_score['total_review'] ])); ?>

                                    <?php else: ?>
                                        <?php echo e(__(":number avaliação",["number"=>$review_score['total_review'] ])); ?>
        ...
        <div class="border-bottom py-4">
            <?php if($review_list->total() > 0): ?>
                <h5 class="font-size-21 font-weight-bold text-dark mb-5 mt-3">
                    <?php echo e(__("Mostrando :from - :to de :total resultados",["from"=>$review_list->firstItem(),"to"=>$review_list->lastItem(),"total"=>$review_list->total()])); ?>

                </h5>
            <?php else: ?>
                <h5 class="font-size-21 font-weight-bold text-dark mb-8">
                    <?php echo e(__("Nenhuma avaliação")); ?>
        ...
        <div class="py-4">
            <?php if($row->check_enable_review_after_booking() and Auth::id()): ?>
                <h5 class="font-size-21 font-weight-bold text-dark mb-6">
                    <?php echo e(__("Escreva uma avaliação")); ?>
                        ...
                        <div class="row mb-5 mb-lg-0">
                            ...
                            <div class="col-sm-12 mb-5">
                                <div class="js-form-message">
                                    <input type="text" class="form-control" name="review_title" placeholder="<?php echo e(__("Título")); ?>" required data-error-class="u-has-error" data-msg="<?php echo e(__('O título da avaliação é obrigatório')); ?>" data-success-class="u-has-success">
                                    <div class="invalid-feedback"><?php echo e(__('O título da avaliação é obrigatório')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 mb-5">
                                <div class="js-form-message">
                                    <div class="input-group">
                                        <textarea class="form-control" rows="6" cols="77" name="review_content" placeholder="<?php echo e(__("Conteúdo da avaliação")); ?>" required data-msg="<?php echo e(__('O conteúdo da avaliação precisa ter no mínimo 10 caracteres')); ?>" data-error-class="u-has-error" data-success-class="u-has-success"></textarea>
                                        <div class="invalid-feedback"><?php echo e(__('O conteúdo da avaliação precisa ter no mínimo 10 caracteres')); ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col d-flex justify-content-center justify-content-lg-start">
                                <button type="submit" id="submit" name="submit" class="btn rounded-xs bg-blue-dark-1 text-white p-2 height-51 width-190 transition-3d-hover">
                                    <?php echo e(__("Enviar Avaliação")); ?>
            ...
            <?php if(!Auth::id()): ?>
                <div class="review-message">
                    <?php echo __("Você precisa <a href='#login' data-toggle='modal' data-target='#login'>entrar</a> para escrever uma avaliação"); ?>
...
<?php endif; ?>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Review/Views/frontend/form.blade.php ENDPATH**/ ?>