...
<div class="container-fluid">
    <div class="d-flex justify-content-between mb20">
        <h1 class="title-bar"><?php echo e(__('Solicitações de Verificaçãos')); ?></h1>
    </div>
    ...
    <div class="text-right">
        <div class="header-status-control">
            <a href="<?php echo e(route('user.admin.verification.index')); ?>"><?php echo e(__("Todas Verificações")); ?></a> -
            <a href="<?php echo e(route('user.admin.verification.index',['status'=>'pending'])); ?>"><?php echo e(__("Pendentes")); ?></a> -
            <a href="<?php echo e(route('user.admin.verification.index',['status'=>'approved'])); ?>"><?php echo e(__("Aprovados")); ?></a>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-success" href="<?php echo e(route('user.admin.verification.detail',['id'=>$row->id])); ?>"><?php echo e(__('Ver verificação')); ?></a>
                                    <?php else: ?>
                                    <a class="btn btn-sm btn-warning" href="<?php echo e(route('user.admin.verification.detail',['id'=>$row->id])); ?>"><?php echo e(__('Ver solicitação')); ?></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/User/Views/admin/verification/index.blade.php ENDPATH**/ ?>