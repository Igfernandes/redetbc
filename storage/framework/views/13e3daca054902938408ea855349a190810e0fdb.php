<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Conteúdo do Evento")); ?></strong></div>
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="video" class="form-control" value="<?php echo e($row->video); ?>" placeholder="<?php echo e(__("Link de vídeo do Youtube")); ?>">
        </div>
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__("Hora de início")); ?></label>
                    <input type="text" name="start_time" class="form-control" value="<?php echo e($row->start_time); ?>" placeholder="<?php echo e(__("Ex: 15:00")); ?>">
                    <small>
                        <?php echo e(__("Formato de entrada de tempo, ex: 15:00")); ?>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <label class="control-label"><?php echo e(__("Duração (hora)")); ?></label>
                    <?php else: ?>
            ...
            <div class="col-lg-6">
                <div class="form-group <?php if( $row->getBookingType()== " ticket"): ?> d-none <?php endif; ?>">
                    <label class="control-label"><?php echo e(__("Unidade de duração")); ?></label>
                    <select name="duration_unit" class="form-control">
                        <option value="hour" <?php if($row->duration_unit == "hour"): ?> selected <?php endif; ?> > <?php echo e(__("Hora")); ?></option>
                        <option value="minute" <?php if($row->duration_unit == "minute"): ?> selected <?php endif; ?> > <?php echo e(__("Minuto")); ?></option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="form-group-item">
            ...
            <div class="g-items">
                ...
                <div class="item" data-number="<?php echo e($key); ?>">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" name="faqs[<?php echo e($key); ?>][title]" class="form-control" value="<?php echo e($faq['title']); ?>" placeholder="<?php echo e(__('Por exemplo: Quando e onde termina o passeio?')); ?>">
                        </div>
                        <div class="col-md-6">
            ...
            <div class="g-more hide">
                <div class="item" data-number="__number__">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" __name__="faqs[__number__][title]" class="form-control" placeholder="<?php echo e(__('Ex: Posso levar meu animal de estimação?')); ?>">
                        </div>
                        <div class="col-md-6">
...
</div><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Event/Views/admin/event/content.blade.php ENDPATH**/ ?>