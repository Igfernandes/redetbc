<div class="g-rules border-bottom">
    <h3 class="font-size-21 font-weight-bold text-dark mb-4"><?php echo e(__("Regras do Hotel - Políticas")); ?></h3>
    <div class="description">
        ...
        <?php if($translation->policy): ?>
            <div class="row">
                <div class="col-lg-4">
                    <div class="key"><?php echo e(__("Políticas do Hotel")); ?></div>
                </div>
                <div class="col-lg-8">
                    ...
                    <?php if( count($translation->policy) > 2): ?>
                        <div class="btn-show-all">
                            <span class="text"><?php echo e(__("Mostrar Todos")); ?></span>
...
</div><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Hotel/Views/frontend/layouts/details/hotel-rules-policy.blade.php ENDPATH**/ ?>