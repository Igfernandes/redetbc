...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid" id="menu-app" data-id="<?php echo e($row->id ?? ''); ?>" v-cloak>
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">
                <?php if(!empty($row->id)): ?>
                    <?php echo e(__("Editarar menu:")); ?> {{name}}
                <?php else: ?>
                    <?php echo e(__('Criar novo menu')); ?>
        ...
        <input type="text" class="form-control" value="<?php echo e($row->name ?? ''); ?>" v-model="name"
               placeholder="<?php echo e(__('Nome do menu')); ?>">
        <br>
        <br>
        <div class="row">
            <div class="col-md-4 col-xl-3 menu-item-types">
                <div v-for="(type,index) in item_types" class="panel panel-toggle-able">
                    ...
                    <div class="panel-body" v-show="type.open">
                        <input type="text" placeholder="<?php echo e(__('Procurar...')); ?>" class="form-control input-sm menu-search"
                        ...
                        <div class="alert-text danger mt10" v-show="!type.items.length"><?php echo e(__("Nenhum item encontrado")); ?></div>
                        <div class="text-right">
                            <span class="btn btn-sm btn-primary" @click="addToMenu(type)"><?php echo e(__('Adicionar ao cardápio')); ?></span>
                        </div>
                    </div>
                </div>
                <div class="panel panel-toggle-able">
                    <div class="panel-title" @click="custom_show = custom_show ? false : true"><?php echo e(__('URL personalizado')); ?>
                    ...
                    <div class="panel-body" v-show="custom_show">
                        ...
                        <div class="form-group">
                            <label><?php echo e(__('Texto do link')); ?></label>
                            <input type="text" v-model="custom_name" class="form-control input-sm">
                        </div>
                        <div class="text-right">
                            <span class="btn btn-sm btn-primary" @click="addCustomUrl"><?php echo e(__('Adicionar ao Menu')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-8 col-xl-9">
                ...
                <div class="lang-content-box">
                    <div class="panel">
                    <div class="panel-title"><?php echo e(__('Itens do menu')); ?></div>
                    <div class="panel-body">
                            ...
                            <Draggable-Tree :value="items" draggable cross-tree :triggerClass="triggerClass">
                                <div slot-scope="{node,index, path, tree}" class="nestable-item-content" >
                                    ...
                                    <div class="menu-info" v-show="node._open">
                                        <div class="form-group">
                                            <label><?php echo e(__('Rótulo')); ?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label><?php echo e(__('Aula')); ?></label>
                                        ...
                                        <div class="mega-group">
                                            <div class="form-group">
                                                <input type="checkbox" v-model="node.mega_menu" :id="'mega-menu-' + path"> <label :for="'mega-menu-' + path"><?php echo e(__('Ativar megamenu')); ?></label>
                                            </div>
                                            <div class="form-group" v-show="node.mega_menu">
                                                <label><?php echo e(__('Colunas')); ?></label>
                                                <select v-model="node.mega_columns" class="input-sm form-control">
                                                    <option value="2"><?php echo e(__('2 colunas')); ?></option>
                                                    <option value="3"><?php echo e(__('3 colunas')); ?></option>
                                                    <option value="4"><?php echo e(__('4 colunas')); ?></option>
                                                </select>
                                            </div>
                                            <div class="form-group" v-show="node.mega_menu">
                                                <label><?php echo e(__('URL da mega imagem')); ?></label>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span v-show="node.origin_name"><?php echo e(__('Origem: ')); ?> <a
                        ...
                        <br>
                        <br>
                        <h3 class="panel-body-title"><?php echo e(__('Configurações de menu')); ?></h3>
                    ...
                    <div class="panel-footer text-right">
                        ...
                        <span class="btn btn-success" @click="saveMenu"><?php echo e(__("Salvar Menu")); ?></span>
                    </div>
                </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Core/Views/admin/menu/detail.blade.php ENDPATH**/ ?>