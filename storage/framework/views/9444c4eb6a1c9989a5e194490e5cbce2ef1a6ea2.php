...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Calendários de disponibilidade de Passeios")); ?></h1>
        </div>
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="filter-div d-flex justify-content-between ">
                    ...
                    <div class="col-right">
                        <?php if($rows->total() > 0): ?>
                            <span class="count-string"><?php echo e(__("Mostrando :from - :to de :total passeios",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()])); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <?php else: ?>
            <div class="alert alert-warning"><?php echo e(__("Nenhum passeio encontrado")); ?></div>
        <?php endif; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row form_modal_calendar form-horizontal" novalidate onsubmit="return false">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label ><?php echo e(__('Número máximo de convidados')); ?></label>
                            ...
                            <div class="col-md-12" v-for="(type,index) in person_types">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <label><?php echo e(__("Preço")); ?></label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Tour/Views/admin/availability.blade.php ENDPATH**/ ?>