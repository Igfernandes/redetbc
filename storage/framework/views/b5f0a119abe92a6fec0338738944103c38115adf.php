                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label ><input type="checkbox" name="user_disable_register" value="1" <?php if(setting_item('user_disable_register')): ?> checked <?php endif; ?>> <?php echo e(__("Sim, please disable it")); ?></label>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="inbox_enable" value="1" <?php if(!empty($settings['inbox_enable'])): ?> checked <?php endif; ?> /> <?php echo e(__("Sim please")); ?> </label>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/User/Views/admin/settings/user.blade.php ENDPATH**/ ?>