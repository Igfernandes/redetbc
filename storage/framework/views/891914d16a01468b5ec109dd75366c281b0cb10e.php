        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <?php else: ?>
                        <div class="form-group">
                            <label> <input type="checkbox" <?php if($settings['user_enable_permanently_delete'] ?? '' == 1): ?> checked <?php endif; ?> disabled name="user_enable_permanently_delete" value="1"> <?php echo e(__("Sim, please enable it")); ?></label>
                        </div>
...
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/User/Views/admin/settings/_permanently_delete.blade.php ENDPATH**/ ?>