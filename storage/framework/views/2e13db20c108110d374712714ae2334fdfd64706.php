...
<?php if(is_default_lang()): ?>
    <div class="form-group">
        <label><?php echo e(__("Celular Contact")); ?></label>
        <div class="form-controls">
            <input type="text" class="form-control" name="phone_contact" value="<?php echo e(setting_item("Celular_contact")); ?>">
        </div>
    </div>
<?php endif; ?>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Core/Views/admin/settings/setting-after-footer.blade.php ENDPATH**/ ?>