            ...
            <div class="container mb-5 mb-lg-9 pb-lg-1">
                <div class="row">
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <?php if($rows->total() > 0): ?>
                            <div class="text-center text-md-left font-size-14 mb-3 text-lh-1"><?php echo e(__("Mostrando :from - :to of :total",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()])); ?></div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/themes/Mytravel/News/Views/frontend/index.blade.php ENDPATH**/ ?>