    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content enquiry_form_modal_form">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo e(__("Consulta")); ?></h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group" >
                    <input type="text" class="form-control" name="enquiry_name" placeholder="<?php echo e(__("Nome *")); ?>">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="enquiry_email" placeholder="<?php echo e(__("Email *")); ?>">
                </div>
                <div class="form-group" v-if="!enquiry_is_submit">
                    <input type="text" class="form-control" name="enquiry_phone" placeholder="<?php echo e(__("Celular")); ?>">
                </div>
                <div class="form-group" v-if="!enquiry_is_submit">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-submit-enquiry"><?php echo e(__("Enviar Agora")); ?>
...
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Booking/Views/frontend/global/enquiry-form.blade.php ENDPATH**/ ?>