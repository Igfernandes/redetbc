                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-right">
                            ...
                            <button class="btn btn-primary mr-2" @click="addFolder">
                                <span><i class="fa fa-folder"></i> <?php echo e(__("Pasta")); ?></span>
                            </button>
                            ...
                            <button class="btn btn-danger mr-2" data-dismiss="modal"><?php echo e(__("Fechar")); ?></button>
                        </div>
                    </div>
                </div>
    ...
    <div :class="viewType == 'grid'  ? 'file-item' : 'file-list-item'" >
        <div class="row hover:bg-f5f5f5 cursor-pointer" v-if="viewType == 'list'" @click="selectFile(file)" :class="{'active':selected.indexOf(file.id) !== -1}">
            ...
            <div class="col-sm-1 py-1  border-right border-bottom d-flex justify-content-end">
                <a :href="file.full_size" target="_blank" title="<?php echo e(__("Visualizar file")); ?>"><i class=" fa fa-eye"></i></a>
            </div>
        </div>
...
</script><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Media/Views/browser.blade.php ENDPATH**/ ?>