...
<div class="panel">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Preço por hora")); ?></label>
                        <input type="number" step="any" min="0" name="price_per_hour" class="form-control" value="<?php echo e($row->price_per_hour); ?>" placeholder="<?php echo e(__("Preço por hora")); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Preço por dia")); ?></label>
                        <input type="number" step="any" name="price_per_day" class="form-control" value="<?php echo e($row->price_per_day); ?>" placeholder="<?php echo e(__("Preço por dia")); ?>">
                    </div>
                </div>
        ...
        <?php if(is_default_lang()): ?>
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label class="control-label"><?php echo e(__("Reserva de horário de início")); ?></label>
                        ...
                        <div class="col-md-6">
                            <label class="control-label"><?php echo e(__("Reserva de horário final")); ?></label>
                    ...
                    <i><?php echo e(__("*Deixe em branco se não usar esses campos. O horário de término deve ser posterior ao horário de início.")); ?></i>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php if(is_default_lang() and (!empty(setting_item("assistance_allow_vendor_can_add_service_fee")) or is_admin())): ?>
            <hr>
...
<?php endif; ?>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Assistance/Views/admin/assistance/pricing.blade.php ENDPATH**/ ?>