...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Calendário de Disponibilidade de Serviços")); ?></h1>
        </div>
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="filter-div d-flex justify-content-between ">
                    ...
                    <div class="col-right">
                        <?php if($rows->total() > 0): ?>
                            <span class="count-string"><?php echo e(__("Mostrando :from - :to de :total serviços",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()])); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <?php else: ?>
            <div class="alert alert-warning"><?php echo e(__("Nenhum serviço encontrado")); ?></div>
        <?php endif; ?>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('Informações de data')); ?></h5>
                    ...
                    <form class="row form_modal_calendar form-horizontal" novalidate onsubmit="return false">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label ><?php echo e(__('Intervalos de datas')); ?></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                <label ><input true-value=1 false-value=0 type="checkbox" v-model="form.active"> <?php echo e(__('Disponível para reserva?')); ?></label>
                            </div>
                        </div>
                        <div class="col-md-6" v-show="form.active">
                            <div class="form-group">
                                <label ><?php echo e(__('Preço por hora')); ?></label>
                                <input type="number"  v-model="form.price_per_hour" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6" v-show="form.active">
                            <div class="form-group">
                                <label ><?php echo e(__('Preço por dia')); ?></label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" @click="saveForm"><?php echo e(__('Salvar alterações')); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
			...
			calendar = new FullCalendar.Calendar(calendarEl, {
				...
				events:{
                    	url:"<?php echo e(route('assistance.admin.availability.loadDates')); ?>",
						extraParams:{
							id:lastId,
                        }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    this.onSubmit = true;
                    $.ajax({
                        url:'<?php echo e(route('assistance.admin.availability.store')); ?>',
                        data:this.form,
                        dataType:'json',
                        method:'post',
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Assistance/Views/admin/availability.blade.php ENDPATH**/ ?>