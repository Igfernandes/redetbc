    ...
    <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="religion" class="form-control">
                            <option value=""><?php echo e(__("Selecione a religião")); ?></option>
                    ...
                    <div class="input-group">
                        <span class="input-group-btn">
                            <span class="btn btn-default btn-file">
                                <?php echo e(__("Procurar")); ?>… <input type="file">
                            </span>
                        </span>
                        <input type="text" data-error="<?php echo e(__("Erro no upload...")); ?>" data-loading="<?php echo e(__("Carregando...")); ?>" class="form-control text-view" readonly value="<?php echo e(get_file_url( old('avatar_id',$dataUser->avatar_id) ) ?? $dataUser->getAvatarUrl()?? __("Sem Imagem")); ?>">
                    </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?php echo e(old('address',$dataUser->address)); ?>" name="address" placeholder="<?php echo e(__("Endereço")); ?>" class="form-control">
                <i class="fa fa-location-arrow input-icon"></i>
            </div>
            <div class="form-group">
                <label><?php echo e(__("Endereço 2")); ?></label>
                <input type="text" value="<?php echo e(old('address2',$dataUser->address2)); ?>" name="address2" placeholder="<?php echo e(__("Endereço2")); ?>" class="form-control">
                <i class="fa fa-location-arrow input-icon"></i>
            </div>
            <div class="form-group">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="mb-4 mt-2">
            <?php echo clean(setting_item_with_lang('user_permanently_delete_content','',__('Sua conta será permanentemente excluída. Depois de excluir sua conta, não há como voltar atrás. Por favor, tenha certeza.'))); ?>

        </div>
        <a data-toggle="modal" data-target="#permanentlyDeleteAccount" class="btn btn-danger" href=""><?php echo e(__('Excluir sua conta')); ?></a>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('Confirmar exclusão permanente da conta')); ?></h5>
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(route('user.permanently.delete')); ?>" class="btn btn-danger"><?php echo e(__('Confirmar')); ?></a>
                </div>
