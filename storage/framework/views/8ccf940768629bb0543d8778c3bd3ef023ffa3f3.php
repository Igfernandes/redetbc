        ...
        <div class="form-group-item">
            <div class="form-group-item">
                <div class="g-items-header">
                    <div class="row">
                        <div class="col-md-4"><?php echo e(__("Título")); ?></div>
                        ...
                        <div class="item" data-number="<?php echo e($key); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <label for=""><?php echo e(__("Celular")); ?></label>
...
</div><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Core/Views/admin/settings/setting-after-contact.blade.php ENDPATH**/ ?>