...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="dashboard-page">
            <h4 class="welcome-title text-uppercase"><?php echo e(__('Bem-vindo :name!',['name'=>Auth::user()->nameOrEmail])); ?></h4>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6 mb-3">
                <div class="panel">
                    <div class="panel-title d-flex justify-content-between align-items-center">
                        <strong><?php echo e(__('Estatísticas de ganhos')); ?></strong>
            ...
            <div class="col-md-12 col-lg-6 ">
                <div class="panel">
                    <div class="panel-title d-flex justify-content-between">
                        <strong><?php echo e(__('Reservas recentes')); ?></strong>
                        <a href="<?php echo e(route('report.admin.booking')); ?>" class="btn-link"><?php echo e(__("Mais")); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th width="100px"><?php echo e(__("Criado em")); ?></th>
                                </tr>
                                </thead>
                                <tbody>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
            ...
            options: {
                ...
                scales: {
                    xAxes: [{
                        ...
                        scaleLabel: {
                            display: true,
                            labelString: '<?php echo e(__("Linha do tempo")); ?>'
                        }
                    }],
                    yAxes: [{
                        stacked: true,
                        ...
                        scaleLabel: {
                            display: true,
                            labelString: '<?php echo e(__("Moeda: :currency_main",['currency_main'=>setting_item('currency_main')])); ?>'
                        },
                        ticks: {
                            beginAtZero: true,
                        }
        ...
        $('#reportrange').daterangepicker({
            ...
            "showDropdowns": true,
            ranges: {
                '<?php echo e(__("Hoje")); ?>': [moment(), moment()],
                '<?php echo e(__("Ontem")); ?>': [moment().subtract(1, 'days'), moment().subtract(1, 'days')],
                '<?php echo e(__("Últimos 7 dias")); ?>': [moment().subtract(6, 'days'), moment()],
                '<?php echo e(__("Últimos 30 dias")); ?>': [moment().subtract(29, 'days'), moment()],
                '<?php echo e(__("Este mês")); ?>': [moment().startOf('month'), moment().endOf('month')],
                '<?php echo e(__("Mês passado")); ?>': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')],
                '<?php echo e(__("Este ano")); ?>': [moment().startOf('year'), moment().endOf('year')],
                '<?php echo e(__('Essa semana')); ?>': [moment().startOf('week'), end]
            }
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Dashboard/Views/index.blade.php ENDPATH**/ ?>