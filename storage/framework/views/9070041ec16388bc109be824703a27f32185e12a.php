<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Mostrar em")); ?></strong></div>
    <div class="panel-body">
        ...
        <hr>
        <div class="form-group">
            <label><?php echo e(__("URLs excluídas")); ?></label>
            <div class="form-controls">
                <div class="form-group-item g-simple">
                    <div class="g-items">
                        <?php
...
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Popup/Views/admin/popup/conditions.blade.php ENDPATH**/ ?>