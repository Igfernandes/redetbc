    ...
    <div class="product-card-block product-card-v3">
        <div class="space-1">
            <div class="w-md-80 w-lg-50 text-center mx-md-auto pb-4">
                <h2 class="section-title text-black font-size-30 font-weight-bold mb-0"><?php echo e(__("Você também pode gostar...")); ?></h2>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Hotel/Views/frontend/layouts/details/hotel-related.blade.php ENDPATH**/ ?>