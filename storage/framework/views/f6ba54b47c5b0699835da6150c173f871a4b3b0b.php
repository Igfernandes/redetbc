    ...
    <div class="container space-1">
        <?php if(!empty($title)): ?>
            <div class="d-flex justify-content-between mb-3 pt-md-3 mt-1 pb-md-3 mb-md-2 align-items-end">
                ...
                <a href="<?php echo e(route("event.search")); ?>" class="font-weight-bold d-flex text-lh-1 mb-md-2 ml-2"><?php echo e(__("Mais")); ?>
...
</div><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Event/Views/frontend/blocks/list-event/style_1.blade.php ENDPATH**/ ?>