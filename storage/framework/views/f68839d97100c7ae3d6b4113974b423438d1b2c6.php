            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" name="sale_price" class="form-control" value="<?php echo e($row->sale_price); ?>" placeholder="<?php echo e(__("Space Preço de Venda")); ?>">
                        <span><i><?php echo e(__("Se o preço normal for menor que o desconto, o preço normal será exibido.")); ?></i></span>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Máximo de convidados")); ?></label>
