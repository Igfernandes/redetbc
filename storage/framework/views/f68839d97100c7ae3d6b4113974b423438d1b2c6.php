...
<div class="panel">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="price" class="form-control" value="<?php echo e($row->price); ?>" placeholder="<?php echo e(__("Preço do Espaço")); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Preço de Venda")); ?></label>
                        <input type="number" step="any" name="sale_price" class="form-control" value="<?php echo e($row->sale_price); ?>" placeholder="<?php echo e(__("Preço de Venda do Espaço")); ?>">
                        <span><i><?php echo e(__("Se o preço normal for menor que o desconto, o preço normal será exibido.")); ?></i></span>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Máximo de hóspedes")); ?></label>
        ...
        <div class="form-group <?php if(!is_default_lang()): ?> d-none <?php endif; ?>">
            <label>
                <input type="checkbox" name="enable_extra_price" <?php if(!empty($row->enable_extra_price)): ?> checked <?php endif; ?> value="1">
                <?php echo e(__('Ativar preço extra')); ?>
                        ...
                        <div class="item" data-number="<?php echo e($key); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <label>
                                        <input type="checkbox" <?php if(!is_default_lang()): ?> disabled <?php endif; ?> name="extra_price[<?php echo e($key); ?>][per_person]" value="on" <?php if(!empty($extra_price['per_person'])): ?> checked <?php endif; ?>>
            ...
            <div class="text-right">
                <?php if(is_default_lang()): ?>
                    <span class="btn btn-info btn-sm btn-add-item">
                        <i class="icon ion-ios-add-circle-outline"></i> <?php echo e(__('Adicionar item')); ?>
...
<?php endif; ?>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Space/Views/admin/space/pricing.blade.php ENDPATH**/ ?>