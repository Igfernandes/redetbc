<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            <label><?php echo e(__("Url de importação")); ?></label>
            <input type="text" value="<?php echo e($row->ical_import_url); ?>"  name="ical_import_url" class="form-control">
        </div>
        <?php if(!empty($row->id)): ?>
        <div class="form-group">
            <label><?php echo e(__("URL de exportação")); ?></label>
            <input type="text" value="<?php echo e(route('booking.admin.export-ical',['type'=>'space',$row->id])); ?>"   class="form-control">
        </div>
            <?php endif; ?>
    </div>
</div>
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Space/Views/admin/space/ical.blade.php ENDPATH**/ ?>