    ...
    <form action="<?php echo e(route('hotel.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->id ? __('Editar: ').$row->title : __('Adicionar novo hotel')); ?></h1>
                    <?php if($row->slug): ?>
                        <p class="item-url-demo"><?php echo e(__("Link permanente")); ?>: <?php echo e(url( config('hotel.hotel_route_prefix') )); ?>/<a href="#" class="open-edit-input" data-name="slug"><?php echo e($row->slug); ?></a>
                        </p>
                    <?php endif; ?>
                </div>
                <div class="">
                    <?php if($row->id): ?>
                        <a class="btn btn-warning btn-xs" href="<?php echo e(route('hotel.admin.room.index',['hotel_id'=>$row->id])); ?>" target="_blank"><i class="fa fa-hand-o-right"></i> <?php echo e(__("Gerenciar Quartos")); ?></a>
                    <?php endif; ?>
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-xs" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>" target="_blank"><?php echo e(__("Visualizar Hotel")); ?></a>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <?php if(is_default_lang()): ?>
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label><?php echo e(__('Hotéis em Destaque')); ?></label>
                                        <br>
                                        <label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\modules/Hotel/Views/admin/detail.blade.php ENDPATH**/ ?>