...
<div class="sidebar-user">
    ...
    <div class="user-profile-avatar">
        <div class="info-new">
            <span class="role-name badge badge-info"><?php echo e($userAuthData->role_name); ?></span>
    ...
    <div class="user-profile-plan">
        <?php if( !Auth::user()->role_id < 2): ?>
            <a href=" <?php echo e(route('user.upgrade')); ?>"><?php echo e(__("Seja Anfitrião")); ?></a>
            <?php endif; ?>
    </div>
    ...
    <div class="logout">
        <a href="<?php echo e(url('/')); ?>" style="color: #1ABC9C"><i class="fa fa-long-arrow-left"></i> <?php echo e(__("Voltar para início")); ?></a>
    </div>
