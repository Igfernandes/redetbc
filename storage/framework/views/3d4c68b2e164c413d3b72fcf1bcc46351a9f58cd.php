<div class="form-group">
    <div class="row align-items-center">
        ...
        <div class="col-md-<?php echo e($value_col_size ?? 4); ?>">
            ...
            <?php else: ?>
                <div class=""><strong style="word-break: break-all;"><?php echo e($field['data'] ? $field['data'] : __('N/A')); ?></strong></div>
...
<?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Base/User/Views/frontend/verification/fields/text.blade.php ENDPATH**/ ?>