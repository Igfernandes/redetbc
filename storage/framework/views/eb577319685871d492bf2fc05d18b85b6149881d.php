        ...
        <div id="bravo_event_book_app" class="bravo_single_book " v-cloak>
            <div class="border border-color-7 rounded mb-5">
                <div class="border-bottom">
                    <div class="p-4">
                        <span class="font-size-14"><?php echo e(__("De")); ?></span>
                ...
                <div class="nav-enquiry" v-if="is_form_enquiry_and_book">
                    <div class="enquiry-item active" >
                        <span><?php echo e(__("Livro")); ?></span>
                    </div>
                    <div class="enquiry-item" data-toggle="modal" data-target="#enquiry_form_modal">
                        <span><?php echo e(__("Consulta")); ?></span>
                    </div>
                </div>
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                        <span class="d-block text-gray-1 font-weight-normal mb-0 text-left"><?php echo e(__("Data de início")); ?></span>
                        <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <div class="border-bottom border-width-2 border-color-1 pb-1">
                                        <div class="flex-center-between mb-1 text-dark font-weight-bold">
                                            <span class="d-block">
                                                {{type.name}} <br>
                                                <small>{{type.display_price}} <?php echo e(__("port ingresso")); ?></small>
                                            </span>
                        ...
                        <div class="mb-4 border-bottom border-width-2 border-color-1 pb-1" v-if="extra_price.length">
                            <h4 class="flex-center-between mb-1 font-size-16 text-dark font-weight-bold"><?php echo e(__('Preços extras:')); ?></h4>
                        ...
                        <ul class="form-section-total mb-4  list-unstyled  pb-1" v-if="total_price > 0">
                            ...
                            <li v-if="is_deposit_ready">
                                <label for=""><?php echo e(__("Pagar agora")); ?></label>
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary d-flex align-items-center justify-content-center  height-60 w-100 mb-xl-0 mb-lg-1 transition-3d-hover font-weight-bold" @click="doSubmit($event)" :class="{'disabled':onSubmit,'btn-success':(step == 2),'btn-primary':step == 1}" name="submit">
                                <span class="stop-color-white"><?php echo e(__("Reserve agora")); ?></span>
                ...
                <div class="form-send-enquiry" v-show="enquiry_type=='enquiry'">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#enquiry_form_modal">
                        <?php echo e(__("Contacte-nos agora")); ?>
...
<?php echo $__env->make("Booking::frontend.global.enquiry-form",['service_type'=>'event'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\CompanyMarket\PROGRESSO\redetbc\themes/Mytravel/Event/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>